...
<p><b>Something to note, since I do not use the Chinese FE tracker DB, a few items might be missing. Currently, my JSON file has 250+ items; if I find any that are missing, I will update it as I play. </b></p>
