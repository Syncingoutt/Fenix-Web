 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ws=new Ra("@firebase/auth");function Zy(n,...e){Ws.logLevel<=H.WARN&&Ws.warn(`Auth (${jn}): ${n}`,...e)}function ks(n,...e){Ws.logLevel<=H.ERROR&&Ws.error(`Auth (${jn}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _r(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function a_(n,e=!1){const t=$e(n),r=await t.getIdToken(e),s=La(r);F(s&&s.exp&&s.auth_time&&s.iat,t.auth,"internal-error");const i=typeof s.firebase=="object"?s.firebase:void 0,a=i==null?void 0:i.sign_in_provider;return{claims:s,token:r,authTime:_r(go(s.auth_time)),issuedAtTime:_r(go(s.iat)),expirationTime:_r(go(s.exp)),signInProvider:a||null,signInSecondFactor:(i==null?void 0:i.sign_in_second_factor)||null}}function go(n){return Number(n)*1e3}function La(n){const[e,t,r]=n.split(".");if(e===void 0||t===void 0||r===void 0)return ks("JWT malformed, contained fewer than 3 sections"),null;try{const s=_d(t);return s?JSON.parse(s):(ks("Failed to decode base64 JWT payload"),null)}catch(s){return ks("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function lu(n){const e=La(n);return F(e,"internal-error"),F(typeof e.exp<"u","internal-error"),F(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ds(n,e,t){return`firebase:${n}:${e}:${t}`}class Sn{constructor(e,t,r){this.persistence=e,this.auth=t,this.userKey=r;const{config:s,name:i}=this.auth;this.fullUserKey=Ds(this.userKey,s.apiKey,i),this.fullPersistenceKey=Ds("persistence",s.apiKey,i),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?st._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,r="authUser"){if(!t.length)return new Sn(it(hu),e,r);const s=(await Promise.all(t.map(async d=>{if(await d._isAvailable())return d}))).filter(d=>d);let i=s[0]||it(hu);const a=Ds(r,e.config.apiKey,e.name);let c=null;for(const d of t)try{const f=await d._get(a);if(f){const m=st._fromJSON(e,f);d!==i&&(c=m),i=d;break}}catch{}const u=s.filter(d=>d._shouldAllowMigration);return!i._shouldAllowMigration||!u.length?new Sn(i,e,r):(i=u[0],c&&await i._set(a,c.toJSON()),await Promise.all(t.map(async d=>{if(d!==i)try{await d._remove(a)}catch{}})),new Sn(i,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function y_(n,e={}){return qn(n,"GET","/v2/passwordPolicy",pi(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function b_(n,e){const t=ka(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(zs(i,e??{}))return s;at(s,"already-initialized")}return t.initialize({options:e})}function S_(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(it);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function C_(n,e,t){const r=mi(n);F(r._canInitEmulator,r,"emulator-config-failed"),F(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,i=Wd(e),{host:a,port:c}=R_(e),u=c===null?"":`:${c}`;r.config.emulator={url:`${i}//${a}${u}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:a,port:c,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})}),P_()}function Wd(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function R_(n){const e=Wd(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:pu(r.substr(i.length+1))}}else{const[i,a]=r.split(":");return{host:i,port:pu(a)}}}function pu(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function P_(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Cn(n,e){return Vd(n,"POST","/v1/accounts:signInWithIdp",pi(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function D_(n,e){return Vd(n,"POST","/v1/accounts:signUp",pi(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qs extends ut{constructor(e,t,r,s){var i;super(t.code,t.message),this.operationType=r,this.user=s,Object.setPrototypeOf(this,Qs.prototype),this.customData={appName:e.name,tenantId:(i=e.tenantId)!==null&&i!==void 0?i:void 0,_serverResponse:t.customData._serverResponse,operationType:r}}static _fromErrorAndOperation(e,t,r,s){return new Qs(e,t,r,s)}}function Yd(n,e,t,r){return(e==="reauthenticate"?t._getReauthenticationResolver(n):t._getIdTokenResponse(n)).catch(i=>{throw i.code==="auth/multi-factor-auth-required"?Qs._fromErrorAndOperation(n,i,e,r):i})}async function V_(n,e,t=!1){const r=await Pr(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return Dt._forOperation(n,"link",r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jd{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(Ys,"1"),this.storage.removeItem(Ys),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sv="pendingRedirect",Ns=new Map;class iv extends of{constructor(e,t,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,r),this.eventId=null}async execute(){let e=Ns.get(this.auth._key());if(!e){try{const r=await ov(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(t){e=()=>Promise.reject(t)}Ns.set(this.auth._key(),e)}return this.bypassAuthState||Ns.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function ov(n,e){const t=lv(e),r=cv(n);if(!await r._isAvailable())return!1;const s=await r._get(t)==="true";return await r._remove(t),s}function av(n,e){Ns.set(n._key(),e)}function cv(n){return it(n._redirectPersistence)}function lv(n){return Ds(sv,n.config.apiKey,n.name)}async function uv(n,e,t=!1){if(nt(n.app))return Promise.reject(St(n));const r=mi(n),s=Z_(r,e),a=await new iv(r,s,t).execute();return a&&!t&&(delete a.user._redirectEventId,await r._persistUserIfCurrent(a.user),await r._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yo="webStorageSupport";class Bv{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=ef,this._completeRedirectFn=uv,this._overrideRedirectResult=av}async _openPopup(e,t,r,s){var i;ct((i=this.eventManagers[e._key()])===null||i===void 0?void 0:i.manager,"_initialize() not called before _openPopup()");const a=await Eu(e,t,r,Ko(),s);return Lv(e,a,Oa())}async _openRedirect(e,t,r,s){await this._originValidation(e);const i=await Eu(e,t,r,Ko(),s);return j_(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:i}=this.eventManagers[t];return s?Promise.resolve(s):(ct(i,"If manager is not set, promise should be"),i)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await Rv(e),r=new dv(e);return t.register("authEvent",s=>(F(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(yo,{type:yo},s=>{var i;const a=(i=s==null?void 0:s[0])===null||i===void 0?void 0:i[yo];a!==void 0&&t(!!a),at(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=yv(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return zd()||Ud()||xa()}}const $v=Bv;var wu="@firebase/auth",Tu="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $a{constructor(e,t){this.previousValue=e,t&&(t.sequenceNumberHandler=r=>this.ie(r),this.se=r=>t.writeSequenceNumber(r))}ie(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.se&&this.se(e),e}}$a.oe=-1;function _i(n){return n==null}function Xs(n){return n===0&&1/n==-1/0}function hI(n){return typeof n=="number"&&Number.isInteger(n)&&!Xs(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ge{constructor(e){this.value=e}static empty(){return new Ge({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!_o(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=vr(t)}setAll(e){let t=ke.emptyPath(),r={},s=[];e.forEach((a,c)=>{if(!t.isImmediateParentOf(c)){const u=this.getFieldsMap(t);this.applyChanges(u,r,s),r={},s=[],t=c.popLast()}a?r[c.lastSegment()]=vr(a):s.push(c.lastSegment())});const i=this.getFieldsMap(t);this.applyChanges(i,r,s)}delete(e){const t=this.field(e.popLast());_o(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return Ye(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=t.mapValue.fields[e.get(r)];_o(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,r){Kr(t,(s,i)=>e[s]=i);for(const s of r)delete e[s]}clone(){return new Ge(vr(this.value))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wa(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Xs(e)?"-0":e}}function Pf(n){return{integerValue:""+n}}function xI(n,e){return hI(e)?Pf(e):Wa(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wi{constructor(){this._=void 0}}function MI(n,e,t){return n instanceof ra?function(s,i){const a={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&Ha(i)&&(i=ja(i)),i&&(a.fields.__previous_value__=i),{mapValue:a}}(t,e):n instanceof ti?kf(n,e):n instanceof ni?Df(n,e):function(s,i){const a=FI(s,i),c=Fu(a)+Fu(s.Pe);return Zo(a)&&Zo(s.Pe)?Pf(c):Wa(s.serializer,c)}(n,e)}function OI(n,e,t){return n instanceof ti?kf(n,e):n instanceof ni?Df(n,e):t}function FI(n,e){return n instanceof sa?function(r){return Zo(r)||function(i){return!!i&&"doubleValue"in i}(r)}(e)?e:{integerValue:0}:null}class ra extends wi{}class ti extends wi{constructor(e){super(),this.elements=e}}function kf(n,e){const t=Nf(e);for(const r of n.elements)t.some(s=>Ye(s,r))||t.push(r);return{arrayValue:{values:t}}}class ni extends wi{constructor(e){super(),this.elements=e}}function Df(n,e){let t=Nf(e);for(const r of n.elements)t=t.filter(s=>!Ye(s,r));return{arrayValue:{values:t}}}class sa extends wi{constructor(e,t){super(),this.serializer=e,this.Pe=t}}function Fu(n){return ce(n.integerValue||n.doubleValue)}function Nf(n){return qa(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}function UI(n,e){return n.field.isEqual(e.field)&&function(r,s){return r instanceof ti&&s instanceof ti||r instanceof ni&&s instanceof ni?Mn(r.elements,s.elements,Ye):r instanceof sa&&s instanceof sa?Ye(r.Pe,s.Pe):r instanceof ra&&s instanceof ra}(n.transform,e.transform)}class Xt{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new Xt}static exists(e){return new Xt(void 0,e)}static updateTime(e){return new Xt(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function xs(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class Ka{}function Vf(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new $I(n.key,Xt.none()):new Qa(n.key,n.data,Xt.none());{const t=n.data,r=Ge.empty();let s=new we(ke.comparator);for(let i of e.fields)if(!s.has(i)){let a=t.field(i);a===null&&i.length>1&&(i=i.popLast(),a=t.field(i)),a===null?r.delete(i):r.set(i,a),s=s.add(i)}return new Ti(n.key,r,new Et(s.toArray()),Xt.none())}}function BI(n,e,t){n instanceof Qa?function(s,i,a){const c=s.value.clone(),u=Bu(s.fieldTransforms,i,a.transformResults);c.setAll(u),i.convertToFoundDocument(a.version,c).setHasCommittedMutations()}(n,e,t):n instanceof Ti?function(s,i,a){if(!xs(s.precondition,i))return void i.convertToUnknownDocument(a.version);const c=Bu(s.fieldTransforms,i,a.transformResults),u=i.data;u.setAll(Lf(s)),u.setAll(c),i.convertToFoundDocument(a.version,u).setHasCommittedMutations()}(n,e,t):function(s,i,a){i.convertToNoDocument(a.version).setHasCommittedMutations()}(0,e,t)}function wr(n,e,t,r){return n instanceof Qa?function(i,a,c,u){if(!xs(i.precondition,a))return c;const d=i.value.clone(),f=$u(i.fieldTransforms,u,a);return d.setAll(f),a.convertToFoundDocument(a.version,d).setHasLocalMutations(),null}(n,e,t,r):n instanceof Ti?function(i,a,c,u){if(!xs(i.precondition,a))return c;const d=$u(i.fieldTransforms,u,a),f=a.data;return f.setAll(Lf(i)),f.setAll(d),a.convertToFoundDocument(a.version,f).setHasLocalMutations(),c===null?null:c.unionWith(i.fieldMask.fields).unionWith(i.fieldTransforms.map(m=>m.field))}(n,e,t,r):function(i,a,c){return xs(i.precondition,a)?(a.convertToNoDocument(a.version).setHasLocalMutations(),null):c}(n,e,t)}function Uu(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!function(r,s){return r===void 0&&s===void 0||!(!r||!s)&&Mn(r,s,(i,a)=>UI(i,a))}(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class Qa extends Ka{constructor(e,t,r,s=[]){super(),this.key=e,this.value=t,this.precondition=r,this.fieldTransforms=s,this.type=0}getFieldMask(){return null}}class Ti extends Ka{constructor(e,t,r,s,i=[]){super(),this.key=e,this.data=t,this.fieldMask=r,this.precondition=s,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function Lf(n){const e=new Map;return n.fieldMask.fields.forEach(t=>{if(!t.isEmpty()){const r=n.data.field(t);e.set(t,r)}}),e}function Bu(n,e,t){const r=new Map;oe(n.length===t.length);for(let s=0;s<t.length;s++){const i=n[s],a=i.transform,c=e.data.field(i.field);r.set(i.field,OI(a,c,t[s]))}return r}function $u(n,e,t){const r=new Map;for(const s of n){const i=s.transform,a=t.data.field(s.field);r.set(s.field,MI(i,a,e))}return r}class $I extends Ka{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ai{constructor(e,t,r,s,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const s=new Map;return s.set(e,Qr.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new Ai(U.min(),s,new le(K),Lt(),G())}}class Qr{constructor(e,t,r,s,i){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new Qr(r,t,G(),G(),G())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class aE{constructor(e){this.ct=e}}function cE(n){const e=nE({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?ei(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let bs=null;function Io(){return bs===null?bs=function(){return 268435456+Math.round(2147483648*Math.random())}():bs++,"0x"+bs.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ce="WebChannelConnection";class xE extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const r=t.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+t.host,this.vo=`projects/${s}/databases/${i}`,this.Co=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${i}`}get Fo(){return!1}Mo(t,r,s,i,a){const c=Io(),u=this.xo(t,r.toUriEncodedString());x("RestConnection",`Sending RPC '${t}' ${c}:`,u,s);const d={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(d,i,a),this.No(t,u,d,s).then(f=>(x("RestConnection",`Received RPC '${t}' ${c}: `,f),f),f=>{throw xn("RestConnection",`RPC '${t}' ${c} failed with error: `,f,"url: ",u,"request:",s),f})}Lo(t,r,s,i,a,c){return this.Mo(t,r,s,i,a)}Oo(t,r,s){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+zn}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((i,a)=>t[a]=i),s&&s.headers.forEach((i,a)=>t[a]=i)}xo(t,r){const s=VE[t];return`${this.Do}/v1/${r}:${s}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,r,s){const i=Io();return new Promise((a,c)=>{const u=new lf;u.setWithCredentials(!0),u.listenOnce(uf.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case Ls.NO_ERROR:const f=u.getResponseJson();x(Ce,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(f)),a(f);break;case Ls.TIMEOUT:x(Ce,`RPC '${e}' ${i} timed out`),c(new L(D.DEADLINE_EXCEEDED,"Request time out"));break;case Ls.HTTP_ERROR:const m=u.getStatus();if(x(Ce,`RPC '${e}' ${i} failed with status:`,m,"response text:",u.getResponseText()),m>0){let g=u.getResponseJson();Array.isArray(g)&&(g=g[0]);const E=g==null?void 0:g.error;if(E&&E.status&&E.message){const C=function(P){const N=P.toLowerCase().replace(/_/g,"-");return Object.values(D).indexOf(N)>=0?N:D.UNKNOWN}(E.status);c(new L(C,E.message))}else c(new L(D.UNKNOWN,"Server responded with status "+u.getStatus()))}else c(new L(D.UNAVAILABLE,"Connection failed."));break;default:$()}}finally{x(Ce,`RPC '${e}' ${i} completed.`)}});const d=JSON.stringify(s);x(Ce,`RPC '${e}' ${i} sending request:`,s),u.send(t,"POST",d,r,15)})}Bo(e,t,r){const s=Io(),i=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=ff(),c=df(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(u.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Oo(u.initMessageHeaders,t,r),u.encodeInitMessageHeaders=!0;const f=i.join("");x(Ce,`Creating RPC '${e}' stream ${s}: ${f}`,u);const m=a.createWebChannel(f,u);let g=!1,E=!1;const C=new LE({Io:P=>{E?x(Ce,`Not sending because RPC '${e}' stream ${s} is closed:`,P):(g||(x(Ce,`Opening RPC '${e}' stream ${s} transport.`),m.open(),g=!0),x(Ce,`RPC '${e}' stream ${s} sending:`,P),m.send(P))},To:()=>m.close()}),R=(P,N,O)=>{P.listen(N,B=>{try{O(B)}catch(z){setTimeout(()=>{throw z},0)}})};return R(m,hr.EventType.OPEN,()=>{E||(x(Ce,`RPC '${e}' stream ${s} transport opened.`),C.yo())}),R(m,hr.EventType.CLOSE,()=>{E||(E=!0,x(Ce,`RPC '${e}' stream ${s} transport closed`),C.So())}),R(m,hr.EventType.ERROR,P=>{E||(E=!0,xn(Ce,`RPC '${e}' stream ${s} transport errored:`,P),C.So(new L(D.UNAVAILABLE,"The operation could not be completed")))}),R(m,hr.EventType.MESSAGE,P=>{var N;if(!E){const O=P.data[0];oe(!!O);const B=O,z=B.error||((N=B[0])===null||N===void 0?void 0:N.error);if(z){x(Ce,`RPC '${e}' stream ${s} received error:`,z);const fe=z.status;let Z=function(v){const w=he[v];if(w!==void 0)return xf(w)}(fe),T=z.message;Z===void 0&&(Z=D.INTERNAL,T="Unknown error status: "+fe+" with message "+z.message),E=!0,C.So(new L(Z,T)),m.close()}else x(Ce,`RPC '${e}' stream ${s} received:`,O),C.bo(O)}}),R(c,hf.STAT_EVENT,P=>{P.stat===Jo.PROXY?x(Ce,`RPC '${e}' stream ${s} detected buffering proxy`):P.stat===Jo.NOPROXY&&x(Ce,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{C.wo()},0),C}}function Eo(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bi(n){return new JI(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ht{constructor(e,t,r){this.converter=t,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new ht(this.firestore,e,this._query)}}class Fe{constructor(e,t,r){this.converter=t,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Pt(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Fe(this.firestore,e,this._key)}}class Pt extends ht{constructor(e,t,r){super(e,t,vi(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Fe(this.firestore,null,new M(e))}withConverter(e){return new Pt(this.firestore,e,this._path)}}function lh(n,e,...t){if(n=$e(n),ap("collection","path",e),n instanceof Ri){const r=ne.fromString(e,...t);return ah(r),new Pt(n,null,r)}{if(!(n instanceof Fe||n instanceof Pt))throw new L(D.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(ne.fromString(e,...t));return ah(r),new Pt(n.firestore,null,r)}}function uh(n,e,...t){if(n=$e(n),arguments.length===1&&(e=mf.newId()),ap("doc","path",e),n instanceof Ri){const r=ne.fromString(e,...t);return oh(r),new Fe(n,null,new M(r))}{if(!(n instanceof Fe||n instanceof Pt))throw new L(D.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(ne.fromString(e,...t));return oh(r),new Fe(n.firestore,n instanceof Pt?n.converter:null,new M(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pr{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class mp extends dp{constructor(e,t,r,s,i,a){super(e,t,r,s,a),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const t=new Os(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){const r=this._document.data.field(Pi("DocumentSnapshot.get",e));if(r!==null)return this._userDataWriter.convertValue(r,t.serverTimestamps)}}}class Os extends mp{data(e={}){return super.data(e)}}class gp{constructor(e,t,r,s){this._firestore=e,this._userDataWriter=t,this._snapshot=s,this.metadata=new pr(s.hasPendingWrites,s.fromCache),this.query=r}get docs(){const e=[];return this.forEach(t=>e.push(t)),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,t){this._snapshot.docs.forEach(r=>{e.call(t,new Os(this._firestore,this._userDataWriter,r.key,r,new pr(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new L(D.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(s,i){if(s._snapshot.oldDocs.isEmpty()){let a=0;return s._snapshot.docChanges.map(c=>{const u=new Os(s._firestore,s._userDataWriter,c.doc.key,c.doc,new pr(s._snapshot.mutatedKeys.has(c.doc.key),s._snapshot.fromCache),s.query.converter);return c.doc,{type:"added",doc:u,oldIndex:-1,newIndex:a++}})}{let a=s._snapshot.oldDocs;return s._snapshot.docChanges.filter(c=>i||c.type!==3).map(c=>{const u=new Os(s._firestore,s._userDataWriter,c.doc.key,c.doc,new pr(s._snapshot.mutatedKeys.has(c.doc.key),s._snapshot.fromCache),s.query.converter);let d=-1,f=-1;return c.type!==0&&(d=a.indexOf(c.doc.key),a=a.delete(c.doc.key)),c.type!==1&&(a=a.add(c.doc),f=a.indexOf(c.doc.key)),{type:kw(c.type),doc:u,oldIndex:d,newIndex:f}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}function kw(n){switch(n){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return $()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function Dw(n){n=Rt(n,Fe);const e=Rt(n.firestore,xr);return dw(hc(e),n._key).then(t=>yp(e,n,t))}class Ec extends Pw{constructor(e){super(),this.firestore=e}convertBytes(e){return new $n(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Fe(this.firestore,null,t)}}function _h(n){n=Rt(n,ht);const e=Rt(n.firestore,xr),t=hc(e),r=new Ec(e);return fp(n._query),fw(t,n._query).then(s=>new gp(e,r,n,s))}function Nw(n,...e){var t,r,s;n=$e(n);let i={includeMetadataChanges:!1,source:"default"},a=0;typeof e[a]!="object"||dh(e[a])||(i=e[a],a++);const c={includeMetadataChanges:i.includeMetadataChanges,source:i.source};if(dh(e[a])){const m=e[a];e[a]=(t=m.next)===null||t===void 0?void 0:t.bind(m),e[a+1]=(r=m.error)===null||r===void 0?void 0:r.bind(m),e[a+2]=(s=m.complete)===null||s===void 0?void 0:s.bind(m)}let u,d,f;if(n instanceof Fe)d=Rt(n.firestore,xr),f=vi(n._key.path),u={next:m=>{e[a]&&e[a](yp(d,n,m))},error:e[a+1],complete:e[a+2]};else{const m=Rt(n,ht);d=Rt(m.firestore,xr),f=m._query;const g=new Ec(d);u={next:E=>{e[a]&&e[a](new gp(d,g,m,E))},error:e[a+1],complete:e[a+2]},fp(n._query)}return function(g,E,C,R){const P=new uc(R),N=new cc(E,P,C);return g.asyncQueue.enqueueAndForget(async()=>ic(await si(g),N)),()=>{P.Za(),g.asyncQueue.enqueueAndForget(async()=>oc(await si(g),N))}}(hc(d),f,c,u)}function yp(n,e,t){const r=t.docs.get(e._key),s=new Ec(n);return new mp(n,s,e._key,r,new pr(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){(function(s){zn=s})(jn),Ln(new tn("firestore",(r,{instanceIdentifier:s,options:i})=>{const a=r.getProvider("app").getImmediate(),c=new xr(new Xv(r.getProvider("auth-internal")),new nI(r.getProvider("app-check-internal")),function(d,f){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new L(D.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Nr(d.options.projectId,f)}(a,s),a);return i=Object.assign({useFetchStreams:t},i),c._setSettings(i),c},"PUBLIC").setMultipleInstances(!0)),bt(Su,"4.7.3",e),bt(Su,"4.7.3","esm2017")})();const _p="fenix_cloud_sync_config",fa={apiKey:"AIzaSyAvz0DRZIJLNHQsHmPg7LaUq9s3N2eEQtg",authDomain:"fenix-2c341.firebaseapp.com",projectId:"fenix-2c341",appId:"1:387287127608:web:c4e5aa07b3b91389c5b8cd",messagingSenderId:"387287127608",storageBucket:"fenix-2c341.firebasestorage.app"},To={enabled:!0,syncConsent:"granted",firebase:{...fa}},Vw=20*60*1e3,mr="s11-vorax",vh=`pricesSnapshots/${mr}`,vp="fenix_price_last_sync_at";function Ss(n){return typeof n=="number"&&Number.isFinite(n)?n:n instanceof me?n.toMillis():null}function Lw(){try{const n=localStorage.getItem(vp),e=n?Number(n):0;return Number.isFinite(e)?e:0}catch{return 0}}function Ih(n){try{localStorage.setItem(vp,String(n))}catch(e){console.error("Failed to persist price sync timestamp:",e)}}function Ao(){try{const n=localStorage.getItem(_p);if(n){const e=JSON.parse(n),t={...To,...e,firebase:{...To.firebase,...e.firebase||{}}};return Ip(xw(t))}}catch(n){console.error("Failed to read cloud sync config:",n)}return{...To}}function xw(n){const e={...n.firebase};let t=!1;return Object.keys(fa).forEach(r=>{const s=e[r];(!s||String(s).trim()==="")&&(e[r]=fa[r],t=!0)}),t?{...n,firebase:e}:n}function Ip(n){let e=n.syncConsent,t=n.enabled;return e||(e="pending"),e==="pending"?t=!1:e==="granted"?t=!0:e==="denied"&&(t=!1),n.syncConsent===e&&n.enabled===t?n:{...n,syncConsent:e,enabled:t}}function Eh(n){try{localStorage.setItem(_p,JSON.stringify(n))}catch(e){console.error("Failed to save cloud sync config:",e)}}function Mw(n){const e=n.firebase;return!!e.apiKey&&!!e.authDomain&&!!e.projectId&&!!e.appId}class Ow{constructor(){this.config=null,this.app=null,this.auth=null,this.db=null,this.lastSyncAt=0,this.lastSyncCache={},this.initializing=null,this.lastSyncCursorMs=null,this.snapshotUnsub=null,this.lastCacheUpdatedAt=null,this.lastCacheError=null,this.onPriceUpdateCallback=null}getSyncStatus(){this.config||(this.config=Ao());const e=Ip(this.config);e!==this.config&&(this.config=e,Eh(this.config));const t=this.config.enabled===!0,r=this.config.syncConsent??"pending";return{enabled:t,consent:r}}async setSyncEnabled(e){this.config||(this.config=Ao());const t=e?"granted":"denied";this.config.enabled=e,this.config.syncConsent=t,Eh(this.config),e&&await this.initialize()}async initialize(){if(this.initializing)return this.initializing;this.initializing=this.initializeInternal();const e=await this.initializing;return this.initializing=null,e}async initializeInternal(){if(this.config=Ao(),typeof this.config.lastSyncCursorMs=="number"&&(this.lastSyncCursorMs=this.config.lastSyncCursorMs),!this.config.enabled)return!1;if(!Mw(this.config))return console.warn("[sync] Firebase config missing. Sync disabled."),!1;if(this.app||(this.app=Ad(this.config.firebase)),this.auth||(this.auth=Kv(this.app)),this.db||(this.db=yw(this.app)),!this.auth.currentUser)try{await N_(this.auth)}catch(e){return console.error("Failed to sign in anonymously:",e),!1}return this.subscribeToSnapshot(),!0}async syncPrices(e){if(!await this.initialize()||!this.db)return{};const r=Date.now();if(this.lastSyncAt||(this.lastSyncAt=Lw()),Object.keys(this.lastSyncCache).length===0&&(this.lastSyncCache=await fd(),Object.keys(this.lastSyncCache).length>0)){const s=Object.values(this.lastSyncCache).map(i=>i.timestamp).filter(i=>typeof i=="number"&&Number.isFinite(i)).reduce((i,a)=>Math.max(i,a),0);this.lastCacheUpdatedAt=s||this.lastCacheUpdatedAt}if(!(e!=null&&e.forceFull)&&this.lastSyncAt&&r-this.lastSyncAt<Vw)return this.lastSyncCache;try{const s=uh(this.db,vh),i=await Dw(s);if(!i.exists())return this.lastCacheError="Price snapshot not available",this.lastSyncCache;const a=i.data(),c=a==null?void 0:a.data,u=Ss(a==null?void 0:a.lastUpdated)??null,d={};if(c&&typeof c=="object")for(const[m,g]of Object.entries(c)){const E=typeof(g==null?void 0:g.price)=="number"?g.price:null,C=Ss(g==null?void 0:g.timestamp);if(E===null||C===null)continue;const R=typeof(g==null?void 0:g.listingCount)=="number"?g.listingCount:void 0;d[m]={price:E,timestamp:C,...R!==void 0?{listingCount:R}:{}}}const f=await Ql(d);return this.lastSyncAt=r,Ih(r),this.lastSyncCache=f,this.lastCacheUpdatedAt=u,this.lastCacheError=null,f}catch(s){return console.error("Failed to sync prices from snapshot:",s),this.lastCacheError="Failed to read prices",this.lastSyncCache}}subscribeToSnapshot(){if(!this.db||this.snapshotUnsub)return;const e=uh(this.db,vh);this.snapshotUnsub=Nw(e,async t=>{if(!t.exists())return;const r=t.data(),s=r==null?void 0:r.data,i=Ss(r==null?void 0:r.lastUpdated)??null,a={};if(s&&typeof s=="object")for(const[u,d]of Object.entries(s)){const f=typeof(d==null?void 0:d.price)=="number"?d.price:null,m=Ss(d==null?void 0:d.timestamp);if(f===null||m===null)continue;const g=typeof(d==null?void 0:d.listingCount)=="number"?d.listingCount:void 0;a[u]={price:f,timestamp:m,...g!==void 0?{listingCount:g}:{}}}const c=await Ql(a);this.lastSyncCache=c,this.lastSyncAt=Date.now(),Ih(this.lastSyncAt),this.lastCacheUpdatedAt=i,this.lastCacheError=null,this.onPriceUpdateCallback&&this.onPriceUpdateCallback(c)},t=>{console.error("Failed to subscribe to price snapshot:",t),this.lastCacheError="Failed to subscribe to price snapshot"})}async getPriceHistory(e){if(!await this.initialize()||!this.db)return[];const r=e.baseId.trim();if(!/^\d+$/.test(r))return[];const s=(e.leagueId||mr).trim()||mr,i=Number.isFinite(e.maxDays)?Math.max(1,Math.min(180,Math.floor(e.maxDays))):120,a=Date.now()-i*24*60*60*1e3,c=Number.isFinite(e.maxSnapshotDocs)?Math.max(100,Math.min(2e4,Math.floor(e.maxSnapshotDocs))):null;try{const u=lh(this.db,"priceChecks",s,"items",r,"events"),d=c!==null?fh(u,ph("timestamp",">=",a),mh("timestamp","asc"),Rw(c)):fh(u,ph("timestamp",">=",a),mh("timestamp","asc"));return(await _h(d)).docs.map(g=>{const E=g.data(),C=typeof E.price=="number"?E.price:null,R=typeof E.timestamp=="number"?E.timestamp:null;if(C===null||R===null)return null;const P=typeof E.listingCount=="number"?E.listingCount:void 0;return{date:new Date(R).toISOString().slice(0,10),timestamp:R,price:C,...P!==void 0?{listingCount:P}:{}}}).filter(g=>g!==null)}catch(u){return console.error("Failed to fetch price history:",u),[]}}async getPriceHistoryBatch(e){if(!await this.initialize()||!this.db)return{};const r=((e==null?void 0:e.leagueId)||mr).trim()||mr;try{const s={},i=lh(this.db,"prices7d",r,"items");return(await _h(i)).docs.forEach(c=>{const u=c.id;if(!/^\d+$/.test(u))return;const d=c.data(),m=(Array.isArray(d.history7d)?d.history7d:[]).map(g=>{if(!g||typeof g!="object")return null;const E=g,C=typeof E.t=="number"?E.t:typeof E.timestamp=="number"?E.timestamp:null,R=typeof E.p=="number"?E.p:typeof E.price=="number"?E.price:null;if(C===null||R===null)return null;const P=typeof E.l=="number"?E.l:typeof E.listingCount=="number"?E.listingCount:void 0;return{date:new Date(C).toISOString().slice(0,10),timestamp:C,price:R,...P!==void 0?{listingCount:P}:{}}}).filter(g=>g!==null).sort((g,E)=>g.timestamp-E.timestamp);m.length>0&&(s[u]=m)}),s}catch(s){return console.error("Failed to fetch batch price history:",s),{}}}getCacheStatus(){return{lastUpdated:this.lastCacheUpdatedAt,lastError:this.lastCacheError}}onPriceUpdate(e){this.onPriceUpdateCallback=e}}let ee=null,kn=null,ae=null,wh=null,Tr=null,ii=0,Ar=0,pa=!1,gr=!1,wc=[],Ep=[];const Tc="fenix_inventory_cache";function Th(){if(!ee)return;const n=ee.getInventory();n.length!==0&&localStorage.setItem(Tc,JSON.stringify(n))}async function wp(){kn=await dd(),ae=new Ow,await ae.setSyncEnabled(!0),ae.onPriceUpdate(async t=>{ee&&(ee.applyPriceCache(t),await yr(ee.getPriceCacheAsObject()),Th(),Fs())});const n=await fd(t=>ae?ae.syncPrices(t):Promise.resolve({}));if(ee=new ig(kn,n),ae&&ee){const t=await ae.syncPrices({forceFull:!0});Object.keys(t).length>0&&(ee.applyPriceCache(t),await yr(ee.getPriceCacheAsObject()))}const e=localStorage.getItem(Tc);if(e&&ee)try{const t=JSON.parse(e);Array.isArray(t)&&(ee.hydrateInventory(t),ee.applyPriceCache(ee.getPriceCacheAsObject()),Fs())}catch(t){console.warn("Failed to restore cached inventory:",t)}setInterval(async()=>{if(ae){const t=await ae.syncPrices({forceFull:!0});ee&&(ee.applyPriceCache(t),await yr(ee.getPriceCacheAsObject()),Th(),Fs())}},20*60*1e3),Fw()}function Fw(){wh||(wh=window.setInterval(()=>{ii++,wc.forEach(n=>n({type:"realtime",seconds:ii}))},1e3))}function Uw(){Tr||(Tr=window.setInterval(()=>{pa&&!gr&&(Ar++,wc.forEach(n=>n({type:"hourly",seconds:Ar})))},1e3))}function Bw(){Tr&&(clearInterval(Tr),Tr=null)}function Fs(){Ep.forEach(n=>n())}const X={async getInventory(){return ee?ee.getInventory().map(e=>e.baseId===en?{...e,price:1}:e):[]},async getItemDatabase(){return kn||(kn=await dd()),kn},async getPriceCache(){return ee?ee.getPriceCacheAsObject():{}},async getPriceHistory(n){if(!ae)return[];const e=(n==null?void 0:n.baseId)??"",t=n==null?void 0:n.leagueId,r=n==null?void 0:n.maxDays,s=n==null?void 0:n.maxSnapshotDocs;return ae.getPriceHistory({baseId:e,leagueId:t,maxDays:r,maxSnapshotDocs:s})},async getPriceHistoryBatch(n){if(!ae)return{};const e=n==null?void 0:n.leagueId,t=n==null?void 0:n.maxDays,r=n==null?void 0:n.maxSnapshotDocs;return ae.getPriceHistoryBatch({leagueId:e,maxDays:t,maxSnapshotDocs:r})},getPriceCacheStatus(){return ae?ae.getCacheStatus():{lastUpdated:null,lastError:"Price sync not initialized"}},onInventoryUpdate(n){Ep.push(n)},startHourlyTimer(){pa=!0,gr=!1,Ar=0,Uw()},pauseHourlyTimer(){gr=!0},resumeHourlyTimer(){gr=!1},stopHourlyTimer(){pa=!1,gr=!1,Ar=0,Bw()},resetRealtimeTimer(){ii=0},async getTimerState(){return{realtimeSeconds:ii,hourlySeconds:Ar}},onTimerTick(n){wc.push(n)},async getAppVersion(){return"2.4.0"},async checkForUpdates(){return{success:!1,message:"Updates not available in web version"}},onUpdateStatus(n){},onUpdateProgress(n){},onShowUpdateDialog(n){},onUpdateDownloadedTransition(n){},sendUpdateDialogResponse(n){},async isLogPathConfigured(){return localStorage.getItem("fenix_log_uploaded")==="true"},async selectLogFile(){return null},onShowLogPathSetup(n){},async getSettings(){return fg()},async saveSettings(n){try{return pg(n),{success:!0}}catch(e){return{success:!1,error:e.message||"Failed to save settings"}}},async getUsernameInfo(){return{canChange:!1}},async setUsername(n){return{success:!1,error:"Username not supported in web version"}},async getCloudSyncStatus(){return ae?ae.getSyncStatus():{enabled:!1,consent:"pending"}},async setCloudSyncEnabled(n){if(!ae)return{success:!1,error:"Price sync service not initialized"};try{return await ae.setSyncEnabled(n),{success:!0}}catch(e){return{success:!1,error:e.message||"Failed to update cloud sync setting"}}},onShowSyncConsent(n){},async testKeybind(n){return{success:!1,error:"Keybinds not supported in web version"}},onCloseSettingsModal(n){},onWindowModeChanged(n){},minimizeWindow(){},maximizeWindow(){},closeWindow(){},openExternal(n){try{window.open(n,"_blank","noopener,noreferrer")}catch(e){console.warn("Failed to open external URL:",e)}},onMaximizeStateChanged(n){},async getMaximizeState(){return!1}};async function Ah(n){return new Promise((e,t)=>{const r=new FileReader;r.onload=async s=>{var i;try{const a=(i=s.target)==null?void 0:i.result,c=gg(a);if((!ee||!kn)&&await wp(),ee){if(ee.buildInventory(c),ae){const u=await ae.syncPrices({forceFull:!0});ee.applyPriceCache(u)}await yr(ee.getPriceCacheAsObject()),localStorage.setItem(Tc,JSON.stringify(ee.getInventory())),localStorage.setItem("fenix_log_uploaded","true"),Fs(),e()}else t(new Error("Inventory manager not initialized"))}catch(a){t(a)}},r.onerror=()=>{t(new Error("Failed to read file"))},r.readAsText(n)})}let Tp=[],Ap={},bp="priceTotal",Sp="desc",Cp="",Rp=null,Pp=null,kp=null,Us=new Set;function dt(){return Tp}function Di(){return Ap}function Ac(){return bp}function bc(){return Sp}function $w(){return Cp}function Dp(){return Rp}function Np(){return Pp}function Vp(){return kp}function Mr(n){return!Us.has(n)}function Hw(n){Tp=n}function jw(n){Ap=n}function qw(n){bp=n}function bh(n){Sp=n}function zw(n){Cp=n}function Sh(n){Rp=n}function Gw(n){Pp=n}function Ww(n){kp=n}function Kw(n){Us.has(n)?Us.delete(n):Us.add(n)}let Lp="realtime",xp=[],Mp=[],Op=new Map,Fp=0,Up=!1,Bp=!1,$p=new Set,Hp=new Map,jp=new Map,qp=new Map,zp=[],Gp=0,Wp=0,Kp=0,Qp=!1;function He(){return Lp}function Ch(n){Lp=n}function Yp(){return xp}function Jp(n){xp=n}function Xr(){return Mp}function Or(n){Mp=n}function Zr(){return Op}function Qw(n){Op=n}function Sc(){return Fp}function Xp(n){Fp=n}function xt(){return Up}function Zp(n){Up=n}function em(){return Bp}function Ni(n){Bp=n}function Ot(){return $p}function Yw(n){$p=n}function Vi(){return Hp}function Jw(n){Hp=n}function Cc(){return jp}function Xw(n){jp=n}function Rc(){return qp}function Zw(n){qp=n}function Pc(){return zp}function Li(n){zp=n}function tm(){return Gp}function kc(n){Gp=n}function eT(){return Wp}function nm(n){Wp=n}function rm(){return Kp}function Dc(n){Kp=n}function tT(){return Qp}function nT(n){Qp=n}let sm=!0;function rT(){return sm}function ma(n){sm=n}function Hn(n){const e=Math.floor(n/3600).toString().padStart(2,"0"),t=Math.floor(n%3600/60).toString().padStart(2,"0"),r=(n%60).toString().padStart(2,"0");return`${e}:${t}:${r}`}function sT(n){return n==="none"?"Uncategorized":n.split("_").map(e=>e.charAt(0).toUpperCase()+e.slice(1).toLowerCase()).join(" ")}function iT(n){if(n===null)return"";const e=Date.now()-n;return e>=ng?"price-very-stale":e>=tg?"price-stale":""}function an(n,e=null){return!rT()||e===en?n:n*(1-rg)}function Nc(n){const e=Np(),t=Vp();if(n.price===null)return!(e!==null&&e>0);const r=n.price*n.totalQuantity,s=an(r,n.baseId);return!(e!==null&&s<e||t!==null&&s>t)}function Vc(){return dt().reduce((e,t)=>{if(!Mr(t.baseId)||!Nc(t))return e;if(t.price!==null){const r=t.totalQuantity*t.price;return e+an(r,t.baseId)}return e},0)}function xi(){const n=dt(),e=Zr(),t=Ot(),r=Np(),s=Vp();let i=0;for(const a of n){if(a.price===null||!Mr(a.baseId)||t.has(a.baseId))continue;const c=a.totalQuantity,u=e.get(a.baseId)||0,d=c-u;if(a.baseId===en){const f=d*a.price;i+=f}else{if(d<=0)continue;const f=d*a.price,m=an(f,a.baseId);if(r!==null&&m<r||s!==null&&m>s)continue;i+=m}}for(const a of t){if(!Mr(a))continue;const c=n.find(g=>g.baseId===a);if(!c||c.price===null)continue;const u=c.totalQuantity,f=(e.get(a)||0)-u;if(f===0)continue;const m=Math.abs(f)*c.price;f>0?i-=m:i+=m}return i}let im,om,Lc,Mi;function oT(n,e,t,r){im=n,om=e,Lc=t,Mi=r}function aT(){const n=Vc();nm(n),Mi(n)}function cT(){Dc(0);const n=Vc();nm(n),Jp([]),X.resetRealtimeTimer(),Lc.textContent=Hn(0),br(),Mi(n)}function br(){const n=Vc(),e=rm()/3600,t=eT(),r=e>0?(n-t)/e:0;Mi(n),He()==="realtime"&&(im.textContent=n.toFixed(2),om.textContent=r.toFixed(2))}async function Rh(){const n=await X.getTimerState();Dc(n.realtimeSeconds),Lc.textContent=Hn(n.realtimeSeconds)}let am,cm,xc,Mc,Oc,es,ts,lm,Fc,Uc;function lT(n,e,t,r,s,i,a,c,u,d){am=n,cm=e,xc=t,Mc=r,Oc=s,es=i,ts=a,lm=c,Fc=u,Uc=d}function uT(){const n=Ot(),e=Di();n.clear();for(const[t,r]of Object.entries(e)){const s=r.group??"";(s==="compass"||s==="beacon"||s==="probe"||s==="scalpel"||(t==="5028"||t==="5040"))&&n.add(t)}}function hT(){uT(),dT()}function dT(){const n=dt(),e=Zr(),t=Vi(),r=Cc(),s=Rc(),i=Ot();e.clear(),t.clear(),r.clear(),s.clear();for(const a of n)e.set(a.baseId,a.totalQuantity),i.has(a.baseId)&&t.set(a.baseId,a.totalQuantity);if(Or([]),Li([]),kc(0),He()==="hourly"){const a=Xr();a.push({time:Date.now(),value:0}),Or(a)}Mc.style.display="none",Oc.style.display="inline-block",es.style.display="inline-block",ts.style.display="none",xc.textContent="00:00:00",Zp(!0),Ni(!1),X.startHourlyTimer(),Sr(),Fc(),Uc()}function fT(){const n=dt(),e=Ot(),t=Vi(),r=Zr(),s=Cc(),i=Rc();for(const a of e){const c=n.find(f=>f.baseId===a),u=c?c.totalQuantity:0,d=t.get(a)??r.get(a)??u;if(r.get(a),u<d){const f=d-u,m=s.get(a)||0;s.set(a,m+f)}if(u>d){const f=u-d,m=i.get(a)||0;i.set(a,m+f)}}}function Bc(){const n=dt(),e=Ot(),t=Vi();for(const r of e){const s=n.find(i=>i.baseId===r);s&&t.set(r,s.totalQuantity)}}function pT(){const n=xi(),e=Math.floor(Sc()/3600),t=tm(),r=Xr(),s=Pc(),i=Ot(),a=dt(),c=Vi(),u=Cc(),d=Rc(),f={hourNumber:e,startValue:t,endValue:n,earnings:n-t,history:[...r]};s.push(f),Li(s),kc(n),Or([{time:Date.now(),value:n}]),u.clear(),d.clear();for(const g of i){const E=a.find(C=>C.baseId===g);E&&c.set(g,E.totalQuantity)}const m=document.querySelector(".stats-container");if(m){const g=document.createElement("div");g.className="earnings-animation",g.textContent=`Hour ${e} Complete! +${f.earnings.toFixed(2)} FE`,g.style.color="#10b981",m.appendChild(g),setTimeout(()=>g.remove(),2e3)}}function mT(){Ni(!0),X.pauseHourlyTimer(),Bc(),es.style.display="none",ts.style.display="inline-block"}function gT(){Ni(!1),X.resumeHourlyTimer(),Bc(),es.style.display="inline-block",ts.style.display="none"}function yT(){X.stopHourlyTimer();const n=xi(),e=Pc(),t=Xr(),r=tm(),i={hourNumber:e.length+1,startValue:r,endValue:n,earnings:n-r,history:[...t]};e.push(i),Li(e),lm(),Mc.style.display="inline-block",Oc.style.display="none",es.style.display="none",ts.style.display="none",xc.textContent="00:00:00",Xp(0),Zp(!1),Ni(!1),Fc(),Uc()}function Sr(){const n=xi(),e=Sc()/3600,t=e>0?n/e:0;He()==="hourly"&&(am.textContent=n.toFixed(2),cm.textContent=t.toFixed(2))}function um(){const n=dt(),e=He(),t=xt();if(e==="hourly"&&t){const r=Zr(),s=Ot();return n.filter(i=>!s.has(i.baseId)).map(i=>{const a=i.totalQuantity,c=r.get(i.baseId)||0,u=a-c;return{...i,totalQuantity:u}}).filter(i=>i.baseId===en?!0:i.totalQuantity>0)}return n}function _T(){const n=um(),e=$w(),t=Dp(),r=Di(),s=Ac(),i=bc();let a=n.filter(c=>{if(e&&!c.itemName.toLowerCase().includes(e.toLowerCase()))return!1;if(t!==null){const u=r[c.baseId];if(((u==null?void 0:u.group)||"none")!==t)return!1}return Nc(c)});return a.sort((c,u)=>{let d=0;if(s==="priceUnit"){const f=c.price??-1,m=u.price??-1;d=f-m}else if(s==="priceTotal"){const f=an((c.price??0)*c.totalQuantity,c.baseId),m=an((u.price??0)*u.totalQuantity,u.baseId);d=f-m}return i==="asc"?d:-d}),a}function vT(){const n=document.getElementById("usageSection"),e=document.getElementById("usageContent");if(!n||!e)return;const t=He(),r=xt(),s=Ot();if(t==="hourly"&&r&&s.size>0){n.style.display="block";const i=dt(),a=Zr(),c=Di(),u=[];for(const f of s){const m=i.find(R=>R.baseId===f),g=m?m.totalQuantity:0,C=(a.get(f)||0)-g;if(!(C<=0)){if(!m){const R=c[f];R&&u.push({baseId:f,itemName:R.name,netUsage:C,price:0});continue}u.push({baseId:f,itemName:m.itemName,netUsage:C,price:m.price||0})}}if(u.length===0){n.style.display="none";return}u.sort((f,m)=>{const g=f.price>0?Math.abs(f.netUsage*f.price):0;return(m.price>0?Math.abs(m.netUsage*m.price):0)-g});let d=0;e.innerHTML=u.map(({baseId:f,itemName:m,netUsage:g,price:E})=>{const C=E>0?E:0,R=E>0?Math.abs(g)*E:0;g>0?d-=R:g<0&&(d+=R);const P=g>0?"-":g<0?"+":"",N=g!==0?`${P}${Math.abs(g)}`:"0",O=g>0?"-":g<0?"+":"",B=E>0&&g!==0?`${O}${R.toFixed(2)} FE`:"- FE";return`
    ...
    <div class="prices-detail-chart-tooltip-row">
      ...
      <img src="${di("100300")}" alt="FE" class="prices-detail-chart-tooltip-icon prices-detail-chart-tooltip-fe-icon" onerror="this.style.display='none'">
