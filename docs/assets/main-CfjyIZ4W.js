 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var z;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(z||(z={}));const Sm={debug:z.DEBUG,verbose:z.VERBOSE,info:z.INFO,warn:z.WARN,error:z.ERROR,silent:z.SILENT},bm=z.INFO,Cm={[z.DEBUG]:"log",[z.VERBOSE]:"log",[z.INFO]:"info",[z.WARN]:"warn",[z.ERROR]:"error"},Rm=(n,e,...t)=>{if(e<n.logLevel)return;const r=new Date().toISOString(),s=Cm[e];if(s)console[s](`[${r}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Lo{constructor(e){this.name=e,this._logLevel=bm,this._logHandler=Rm,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in z))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Sm[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,z.DEBUG,...e),this._logHandler(this,z.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,z.VERBOSE,...e),this._logHandler(this,z.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,z.INFO,...e),this._logHandler(this,z.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,z.WARN,...e),this._logHandler(this,z.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,z.ERROR,...e),this._logHandler(this,z.ERROR,...e)}}const Pm=(n,e)=>e.some(t=>n instanceof t);let Bc,$c;function km(){return Bc||(Bc=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Dm(){return $c||($c=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const th=new WeakMap,Xi=new WeakMap,nh=new WeakMap,Pi=new WeakMap,Vo=new WeakMap;function Nm(n){const e=new Promise((t,r)=>{const s=()=>{n.removeEventListener("success",i),n.removeEventListener("error",a)},i=()=>{t(pt(n.result)),s()},a=()=>{r(n.error),s()};n.addEventListener("success",i),n.addEventListener("error",a)});return e.then(t=>{t instanceof IDBCursor&&th.set(t,n)}).catch(()=>{}),Vo.set(e,n),e}function Lm(n){if(Xi.has(n))return;const e=new Promise((t,r)=>{const s=()=>{n.removeEventListener("complete",i),n.removeEventListener("error",a),n.removeEventListener("abort",a)},i=()=>{t(),s()},a=()=>{r(n.error||new DOMException("AbortError","AbortError")),s()};n.addEventListener("complete",i),n.addEventListener("error",a),n.addEventListener("abort",a)});Xi.set(n,e)}let Zi={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return Xi.get(n);if(e==="objectStoreNames")return n.objectStoreNames||nh.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return pt(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function Vm(n){Zi=n(Zi)}function Mm(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const r=n.call(ki(this),e,...t);return nh.set(r,e.sort?e.sort():[e]),pt(r)}:Dm().includes(n)?function(...e){return n.apply(ki(this),e),pt(th.get(this))}:function(...e){return pt(n.apply(ki(this),e))}}function Om(n){return typeof n=="function"?Mm(n):(n instanceof IDBTransaction&&Lm(n),Pm(n,km())?new Proxy(n,Zi):n)}function pt(n){if(n instanceof IDBRequest)return Nm(n);if(Pi.has(n))return Pi.get(n);const e=Om(n);return e!==n&&(Pi.set(n,e),Vo.set(e,n)),e}const ki=n=>Vo.get(n);function xm(n,e,{blocked:t,upgrade:r,blocking:s,terminated:i}={}){const a=indexedDB.open(n,e),c=pt(a);return r&&a.addEventListener("upgradeneeded",u=>{r(pt(a.result),u.oldVersion,u.newVersion,pt(a.transaction),u)}),t&&a.addEventListener("blocked",u=>t(u.oldVersion,u.newVersion,u)),c.then(u=>{i&&u.addEventListener("close",()=>i()),s&&u.addEventListener("versionchange",d=>s(d.oldVersion,d.newVersion,d))}).catch(()=>{}),c}const Fm=["get","getKey","getAll","getAllKeys","count"],Um=["put","add","delete","clear"],Di=new Map;function Hc(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(Di.get(e))return Di.get(e);const t=e.replace(/FromIndex$/,""),r=e!==t,s=Um.includes(t);if(!(t in(r?IDBIndex:IDBObjectStore).prototype)||!(s||Fm.includes(t)))return;const i=async function(a,...c){const u=this.transaction(a,s?"readwrite":"readonly");let d=u.store;return r&&(d=d.index(c.shift())),(await Promise.all([d[t](...c),s&&u.done]))[0]};return Di.set(e,i),i}Vm(n=>({...n,get:(e,t,r)=>Hc(e,t)||n.get(e,t,r),has:(e,t)=>!!Hc(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bm{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if($m(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function $m(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const eo="@firebase/app",jc="0.10.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Is=new Map,gg=new Map,no=new Map;function qc(n,e){try{n.container.addComponent(e)}catch(t){Ye.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function fn(n){const e=n.name;if(no.has(e))return Ye.debug(`There were multiple attempts to register component ${e}.`),!1;no.set(e,n);for(const t of Is.values())qc(t,n);for(const t of gg.values())qc(t,n);return!0}function Mo(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function We(n){return n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tn=pg;function rh(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r=Object.assign({name:to,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw mt.create("bad-app-name",{appName:String(s)});if(t||(t=Zu()),!t)throw mt.create("no-options");const i=Is.get(s);if(i){if(vs(t,i.options)&&vs(r,i.config))return i;throw mt.create("duplicate-app",{appName:s})}const a=new Am(s);for(const u of no.values())a.addComponent(u);const c=new _g(t,r,a);return Is.set(s,c),c}function sh(n=to){const e=Is.get(n);if(!e&&n===to&&Zu())return rh();if(!e)throw mt.create("no-app",{appName:n});return e}function gt(n,e,t){var r;let s=(r=mg[n])!==null&&r!==void 0?r:n;t&&(s+=`-${t}`);const i=s.match(/\s|\//),a=e.match(/\s|\//);if(i||a){const c=[`Unable to register library "${s}" with version "${e}":`];i&&c.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&a&&c.push("and"),a&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Ye.warn(c.join(" "));return}fn(new xt(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cg(n){fn(new xt("platform-logger",e=>new Bm(e),"PRIVATE")),fn(new xt("heartbeat",e=>new Ag(e),"PRIVATE")),gt(eo,jc,n),gt(eo,jc,"esm2017"),gt("fire-js","")}Cg("");var Rg="firebase",Pg="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Es=new Lo("@firebase/auth");function Dg(n,...e){Es.logLevel<=z.WARN&&Es.warn(`Auth (${Tn}): ${n}`,...e)}function os(n,...e){Es.logLevel<=z.ERROR&&Es.error(`Auth (${Tn}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ro(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.href)||""}function Ng(){return Kc()==="http:"||Kc()==="https:"}function Kc(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ts(n){var e;const t=n.auth,r=await n.getIdToken(),s=await ur(n,ph(t,{idToken:r}));B(s==null?void 0:s.users.length,t,"internal-error");const i=s.users[0];n._notifyReloadListener(i);const a=!((e=i.providerUserInfo)===null||e===void 0)&&e.length?mh(i.providerUserInfo):[],c=jg(n.providerData,a),u=n.isAnonymous,d=!(n.email&&i.passwordHash)&&!(c!=null&&c.length),f=u?d:!1,y={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:c,metadata:new so(i.createdAt,i.lastLoginAt),isAnonymous:f};Object.assign(n,y)}async function Hg(n){const e=Tt(n);await Ts(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function jg(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function mh(n){return n.map(e=>{var{providerId:t}=e,r=Oo(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qg(n,e={}){return wn(n,"GET","/v2/passwordPolicy",Os(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ry(n,e){const t=Mo(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(vs(i,e??{}))return s;Xe(s,"already-initialized")}return t.initialize({options:e})}function sy(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(Je);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function iy(n,e,t){const r=xs(n);B(r._canInitEmulator,r,"emulator-config-failed"),B(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,i=bh(e),{host:a,port:c}=oy(e),u=c===null?"":`:${c}`;r.config.emulator={url:`${i}//${a}${u}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:a,port:c,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})}),ay()}function bh(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function oy(n){const e=bh(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:el(r.substr(i.length+1))}}else{const[i,a]=r.split(":");return{host:i,port:el(a)}}}function el(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function ay(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function an(n,e){return dh(n,"POST","/v1/accounts:signInWithIdp",Os(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ly(n,e){return dh(n,"POST","/v1/accounts:signUp",Os(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ws extends tt{constructor(e,t,r,s){var i;super(t.code,t.message),this.operationType=r,this.user=s,Object.setPrototypeOf(this,ws.prototype),this.customData={appName:e.name,tenantId:(i=e.tenantId)!==null&&i!==void 0?i:void 0,_serverResponse:t.customData._serverResponse,operationType:r}}static _fromErrorAndOperation(e,t,r,s){return new ws(e,t,r,s)}}function Ph(n,e,t,r){return(e==="reauthenticate"?t._getReauthenticationResolver(n):t._getIdTokenResponse(n)).catch(i=>{throw i.code==="auth/multi-factor-auth-required"?ws._fromErrorAndOperation(n,i,e,r):i})}async function hy(n,e,t=!1){const r=await ur(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return _t._forOperation(n,"link",r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vi="webStorageSupport";class __{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Lh,this._completeRedirectFn=Hy,this._overrideRedirectResult=Uy}async _openPopup(e,t,r,s){var i;Ze((i=this.eventManagers[e._key()])===null||i===void 0?void 0:i.manager,"_initialize() not called before _openPopup()");const a=await al(e,t,r,ro(),s);return d_(e,a,Ho())}async _openRedirect(e,t,r,s){await this._originValidation(e);const i=await al(e,t,r,ro(),s);return Ey(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:i}=this.eventManagers[t];return s?Promise.resolve(s):(Ze(i,"If manager is not set, promise should be"),i)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await o_(e),r=new qy(e);return t.register("authEvent",s=>(B(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Vi,{type:Vi},s=>{var i;const a=(i=s==null?void 0:s[0])===null||i===void 0?void 0:i[Vi];a!==void 0&&t(!!a),Xe(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Qy(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Ah()||_h()||Bo()}}const v_=__;var cl="@firebase/auth",ll="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gh{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class R_{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(_e.UNAUTHENTICATED))}shutdown(){}}class P_{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable(()=>t(this.token.user))}shutdown(){this.changeListener=null}}class k_{constructor(e){this.t=e,this.currentUser=_e.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){re(this.o===void 0);let r=this.i;const s=u=>this.i!==r?(r=this.i,t(u)):Promise.resolve();let i=new Mt;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new Mt,e.enqueueRetryable(()=>s(this.currentUser))};const a=()=>{const u=i;e.enqueueRetryable(async()=>{await u.promise,await s(this.currentUser)})},c=u=>{O("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=u,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit(u=>c(u)),setTimeout(()=>{if(!this.auth){const u=this.t.getImmediate({optional:!0});u?c(u):(O("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new Mt)}},0),a()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(r=>this.i!==e?(O("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(re(typeof r.accessToken=="string"),new Gh(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return re(e===null||typeof e=="string"),new _e(e)}}class D_{constructor(e,t,r){this.l=e,this.h=t,this.P=r,this.type="FirstParty",this.user=_e.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const e=this.T();return e&&this.I.set("Authorization",e),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class N_{constructor(e,t,r){this.l=e,this.h=t,this.P=r}getToken(){return Promise.resolve(new D_(this.l,this.h,this.P))}start(e,t){e.enqueueRetryable(()=>t(_e.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class L_{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class V_{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,t){re(this.o===void 0);const r=i=>{i.error!=null&&O("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const a=i.token!==this.R;return this.R=i.token,O("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?t(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable(()=>r(i))};const s=i=>{O("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(i=>s(i)),setTimeout(()=>{if(!this.appCheck){const i=this.A.getImmediate({optional:!0});i?s(i):O("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(t=>t?(re(typeof t.token=="string"),this.R=t.token,new L_(t.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Go{constructor(e,t){this.previousValue=e,t&&(t.sequenceNumberHandler=r=>this.ie(r),this.se=r=>t.writeSequenceNumber(r))}ie(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.se&&this.se(e),e}}Go.oe=-1;function Bs(n){return n==null}function ao(n){return n===0&&1/n==-1/0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fl(n){let e=0;for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e++;return e}function $s(n,e){for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e(t,n[t])}function j_(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class de{constructor(e){this.binaryString=e}static fromBase64String(e){const t=function(s){try{return atob(s)}catch(i){throw typeof DOMException<"u"&&i instanceof DOMException?new Kh("Invalid base64 string: "+i):i}}(e);return new de(t)}static fromUint8Array(e){const t=function(s){let i="";for(let a=0;a<s.length;++a)i+=String.fromCharCode(s[a]);return i}(e);return new de(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(t){return btoa(t)}(this.binaryString)}toUint8Array(){return function(t){const r=new Uint8Array(t.length);for(let s=0;s<t.length;s++)r[s]=t.charCodeAt(s);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return J(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}de.EMPTY_BYTE_STRING=new de("");const q_=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function It(n){if(re(!!n),typeof n=="string"){let e=0;const t=q_.exec(n);if(re(!!t),t[1]){let s=t[1];s=(s+"000000000").substr(0,9),e=Number(s)}const r=new Date(n);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:se(n.seconds),nanos:se(n.nanos)}}function se(n){return typeof n=="number"?n:typeof n=="string"?Number(n):0}function Bt(n){return typeof n=="string"?de.fromBase64String(n):de.fromUint8Array(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wo(n){var e,t;return((t=(((e=n==null?void 0:n.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||t===void 0?void 0:t.stringValue)==="server_timestamp"}function Ko(n){const e=n.mapValue.fields.__previous_value__;return Wo(e)?Ko(e):e}function dr(n){const e=It(n.mapValue.fields.__local_write_time__.timestampValue);return new be(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ve{constructor(e){this.value=e}static empty(){return new Ve({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!Mi(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=Zn(t)}setAll(e){let t=Se.emptyPath(),r={},s=[];e.forEach((a,c)=>{if(!t.isImmediateParentOf(c)){const u=this.getFieldsMap(t);this.applyChanges(u,r,s),r={},s=[],t=c.popLast()}a?r[c.lastSegment()]=Zn(a):s.push(c.lastSegment())});const i=this.getFieldsMap(t);this.applyChanges(i,r,s)}delete(e){const t=this.field(e.popLast());Mi(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return Ue(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=t.mapValue.fields[e.get(r)];Mi(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,r){$s(t,(s,i)=>e[s]=i);for(const s of r)delete e[s]}clone(){return new Ve(Zn(this.value))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cs{constructor(e,t="asc"){this.field=e,this.dir=t}}function K_(n,e){return n.dir===e.dir&&n.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Qh{}class ae extends Qh{constructor(e,t,r){super(),this.field=e,this.op=t,this.value=r}static create(e,t,r){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,r):new J_(e,t,r):t==="array-contains"?new Z_(e,r):t==="in"?new ev(e,r):t==="not-in"?new tv(e,r):t==="array-contains-any"?new nv(e,r):new ae(e,t,r)}static createKeyFieldInFilter(e,t,r){return t==="in"?new Y_(e,r):new X_(e,r)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&this.matchesComparison(gn(t,this.value)):t!==null&&$t(this.value)===$t(t)&&this.matchesComparison(gn(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return j()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class Be extends Qh{constructor(e,t){super(),this.filters=e,this.op=t,this.ae=null}static create(e,t){return new Be(e,t)}matches(e){return Jh(this)?this.filters.find(t=>!t.matches(e))===void 0:this.filters.find(t=>t.matches(e))!==void 0}getFlattenedFilters(){return this.ae!==null||(this.ae=this.filters.reduce((e,t)=>e.concat(t.getFlattenedFilters()),[])),this.ae}getFilters(){return Object.assign([],this.filters)}}function Jh(n){return n.op==="and"}function Yh(n){return Q_(n)&&Jh(n)}function Q_(n){for(const e of n.filters)if(e instanceof Be)return!1;return!0}function uo(n){if(n instanceof ae)return n.field.canonicalString()+n.op.toString()+yn(n.value);if(Yh(n))return n.filters.map(e=>uo(e)).join(",");{const e=n.filters.map(t=>uo(t)).join(",");return`${n.op}(${e})`}}function Xh(n,e){return n instanceof ae?function(r,s){return s instanceof ae&&r.op===s.op&&r.field.isEqual(s.field)&&Ue(r.value,s.value)}(n,e):n instanceof Be?function(r,s){return s instanceof Be&&r.op===s.op&&r.filters.length===s.filters.length?r.filters.reduce((i,a,c)=>i&&Xh(a,s.filters[c]),!0):!1}(n,e):void j()}function Zh(n){return n instanceof ae?function(t){return`${t.field.canonicalString()} ${t.op} ${yn(t.value)}`}(n):n instanceof Be?function(t){return t.op.toString()+" {"+t.getFilters().map(Zh).join(" ,")+"}"}(n):"Filter"}class J_ extends ae{constructor(e,t,r){super(e,t,r),this.key=U.fromName(r.referenceValue)}matches(e){const t=U.comparator(e.key,this.key);return this.matchesComparison(t)}}class Y_ extends ae{constructor(e,t){super(e,"in",t),this.keys=ed("in",t)}matches(e){return this.keys.some(t=>t.isEqual(e.key))}}class X_ extends ae{constructor(e,t){super(e,"not-in",t),this.keys=ed("not-in",t)}matches(e){return!this.keys.some(t=>t.isEqual(e.key))}}function ed(n,e){var t;return(((t=e.arrayValue)===null||t===void 0?void 0:t.values)||[]).map(r=>U.fromName(r.referenceValue))}class Z_ extends ae{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return Qo(t)&&pr(t.arrayValue,this.value)}}class ev extends ae{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&pr(this.value.arrayValue,t)}}class tv extends ae{constructor(e,t){super(e,"not-in",t)}matches(e){if(pr(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&!pr(this.value.arrayValue,t)}}class nv extends ae{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!Qo(t)||!t.arrayValue.values)&&t.arrayValue.values.some(r=>pr(this.value.arrayValue,r))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lv=new ie(U.comparator);function Et(){return lv}const rd=new ie(U.comparator);function Wn(...n){let e=rd;for(const t of n)e=e.insert(t.key,t);return e}function uv(n){let e=rd;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function Lt(){return tr()}function sd(){return tr()}function tr(){return new Sn(n=>n.toString(),(n,e)=>n.isEqual(e))}const hv=new he(U.comparator);function K(...n){let e=hv;for(const t of n)e=e.add(t);return e}const dv=new he(J);function fv(){return dv}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pv(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:ao(e)?"-0":e}}function mv(n){return{integerValue:""+n}}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gs{constructor(){this._=void 0}}function gv(n,e,t){return n instanceof po?function(s,i){const a={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&Wo(i)&&(i=Ko(i)),i&&(a.fields.__previous_value__=i),{mapValue:a}}(t,e):n instanceof Rs?id(n,e):n instanceof Ps?od(n,e):function(s,i){const a=_v(s,i),c=wl(a)+wl(s.Pe);return lo(a)&&lo(s.Pe)?mv(c):pv(s.serializer,c)}(n,e)}function yv(n,e,t){return n instanceof Rs?id(n,e):n instanceof Ps?od(n,e):t}function _v(n,e){return n instanceof mo?function(r){return lo(r)||function(i){return!!i&&"doubleValue"in i}(r)}(e)?e:{integerValue:0}:null}class po extends Gs{}class Rs extends Gs{constructor(e){super(),this.elements=e}}function id(n,e){const t=ad(e);for(const r of n.elements)t.some(s=>Ue(s,r))||t.push(r);return{arrayValue:{values:t}}}class Ps extends Gs{constructor(e){super(),this.elements=e}}function od(n,e){let t=ad(e);for(const r of n.elements)t=t.filter(s=>!Ue(s,r));return{arrayValue:{values:t}}}class mo extends Gs{constructor(e,t){super(),this.serializer=e,this.Pe=t}}function wl(n){return se(n.integerValue||n.doubleValue)}function ad(n){return Qo(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}function vv(n,e){return n.field.isEqual(e.field)&&function(r,s){return r instanceof Rs&&s instanceof Rs||r instanceof Ps&&s instanceof Ps?mn(r.elements,s.elements,Ue):r instanceof mo&&s instanceof mo?Ue(r.Pe,s.Pe):r instanceof po&&s instanceof po}(n.transform,e.transform)}class Ot{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new Ot}static exists(e){return new Ot(void 0,e)}static updateTime(e){return new Ot(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function hs(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class Xo{}function cd(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new Ev(n.key,Ot.none()):new Zo(n.key,n.data,Ot.none());{const t=n.data,r=Ve.empty();let s=new he(Se.comparator);for(let i of e.fields)if(!s.has(i)){let a=t.field(i);a===null&&i.length>1&&(i=i.popLast(),a=t.field(i)),a===null?r.delete(i):r.set(i,a),s=s.add(i)}return new Ws(n.key,r,new dt(s.toArray()),Ot.none())}}function Iv(n,e,t){n instanceof Zo?function(s,i,a){const c=s.value.clone(),u=Sl(s.fieldTransforms,i,a.transformResults);c.setAll(u),i.convertToFoundDocument(a.version,c).setHasCommittedMutations()}(n,e,t):n instanceof Ws?function(s,i,a){if(!hs(s.precondition,i))return void i.convertToUnknownDocument(a.version);const c=Sl(s.fieldTransforms,i,a.transformResults),u=i.data;u.setAll(ld(s)),u.setAll(c),i.convertToFoundDocument(a.version,u).setHasCommittedMutations()}(n,e,t):function(s,i,a){i.convertToNoDocument(a.version).setHasCommittedMutations()}(0,e,t)}function nr(n,e,t,r){return n instanceof Zo?function(i,a,c,u){if(!hs(i.precondition,a))return c;const d=i.value.clone(),f=bl(i.fieldTransforms,u,a);return d.setAll(f),a.convertToFoundDocument(a.version,d).setHasLocalMutations(),null}(n,e,t,r):n instanceof Ws?function(i,a,c,u){if(!hs(i.precondition,a))return c;const d=bl(i.fieldTransforms,u,a),f=a.data;return f.setAll(ld(i)),f.setAll(d),a.convertToFoundDocument(a.version,f).setHasLocalMutations(),c===null?null:c.unionWith(i.fieldMask.fields).unionWith(i.fieldTransforms.map(y=>y.field))}(n,e,t,r):function(i,a,c){return hs(i.precondition,a)?(a.convertToNoDocument(a.version).setHasLocalMutations(),null):c}(n,e,t)}function Al(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!function(r,s){return r===void 0&&s===void 0||!(!r||!s)&&mn(r,s,(i,a)=>vv(i,a))}(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class Zo extends Xo{constructor(e,t,r,s=[]){super(),this.key=e,this.value=t,this.precondition=r,this.fieldTransforms=s,this.type=0}getFieldMask(){return null}}class Ws extends Xo{constructor(e,t,r,s,i=[]){super(),this.key=e,this.data=t,this.fieldMask=r,this.precondition=s,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function ld(n){const e=new Map;return n.fieldMask.fields.forEach(t=>{if(!t.isEmpty()){const r=n.data.field(t);e.set(t,r)}}),e}function Sl(n,e,t){const r=new Map;re(n.length===t.length);for(let s=0;s<t.length;s++){const i=n[s],a=i.transform,c=e.data.field(i.field);r.set(i.field,yv(a,c,t[s]))}return r}function bl(n,e,t){const r=new Map;for(const s of n){const i=s.transform,a=t.data.field(s.field);r.set(s.field,gv(i,a,e))}return r}class Ev extends Xo{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ks{constructor(e,t,r,s,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const s=new Map;return s.set(e,wr.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new Ks($.min(),s,new ie(J),Et(),K())}}class wr{constructor(e,t,r,s,i){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new wr(r,t,K(),K(),K())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ds{constructor(e,t,r,s){this.Re=e,this.removedTargetIds=t,this.key=r,this.Ve=s}}class hd{constructor(e,t){this.targetId=e,this.me=t}}class dd{constructor(e,t,r=de.EMPTY_BYTE_STRING,s=null){this.state=e,this.targetIds=t,this.resumeToken=r,this.cause=s}}class Pl{constructor(){this.fe=0,this.ge=Dl(),this.pe=de.EMPTY_BYTE_STRING,this.ye=!1,this.we=!0}get current(){return this.ye}get resumeToken(){return this.pe}get Se(){return this.fe!==0}get be(){return this.we}De(e){e.approximateByteSize()>0&&(this.we=!0,this.pe=e)}ve(){let e=K(),t=K(),r=K();return this.ge.forEach((s,i)=>{switch(i){case 0:e=e.add(s);break;case 2:t=t.add(s);break;case 1:r=r.add(s);break;default:j()}}),new wr(this.pe,this.ye,e,t,r)}Ce(){this.we=!1,this.ge=Dl()}Fe(e,t){this.we=!0,this.ge=this.ge.insert(e,t)}Me(e){this.we=!0,this.ge=this.ge.remove(e)}xe(){this.fe+=1}Oe(){this.fe-=1,re(this.fe>=0)}Ne(){this.we=!0,this.ye=!0}}class Cv{constructor(e){this.Le=e,this.Be=new Map,this.ke=Et(),this.qe=kl(),this.Qe=new ie(J)}Ke(e){for(const t of e.Re)e.Ve&&e.Ve.isFoundDocument()?this.$e(t,e.Ve):this.Ue(t,e.key,e.Ve);for(const t of e.removedTargetIds)this.Ue(t,e.key,e.Ve)}We(e){this.forEachTarget(e,t=>{const r=this.Ge(t);switch(e.state){case 0:this.ze(t)&&r.De(e.resumeToken);break;case 1:r.Oe(),r.Se||r.Ce(),r.De(e.resumeToken);break;case 2:r.Oe(),r.Se||this.removeTarget(t);break;case 3:this.ze(t)&&(r.Ne(),r.De(e.resumeToken));break;case 4:this.ze(t)&&(this.je(t),r.De(e.resumeToken));break;default:j()}})}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.Be.forEach((r,s)=>{this.ze(s)&&t(s)})}He(e){const t=e.targetId,r=e.me.count,s=this.Je(t);if(s){const i=s.target;if(ho(i))if(r===0){const a=new U(i.path);this.Ue(t,a,ve.newNoDocument(a,$.min()))}else re(r===1);else{const a=this.Ye(t);if(a!==r){const c=this.Ze(e),u=c?this.Xe(c,e,a):1;if(u!==0){this.je(t);const d=u===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Qe=this.Qe.insert(t,d)}}}}}Ze(e){const t=e.me.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:r="",padding:s=0},hashCount:i=0}=t;let a,c;try{a=Bt(r).toUint8Array()}catch(u){if(u instanceof Kh)return pn("Decoding the base64 bloom filter in existence filter failed ("+u.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw u}try{c=new ea(a,s,i)}catch(u){return pn(u instanceof Kn?"BloomFilter error: ":"Applying bloom filter failed: ",u),null}return c.Ie===0?null:c}Xe(e,t,r){return t.me.count===r-this.nt(e,t.targetId)?0:2}nt(e,t){const r=this.Le.getRemoteKeysForTarget(t);let s=0;return r.forEach(i=>{const a=this.Le.tt(),c=`projects/${a.projectId}/databases/${a.database}/documents/${i.path.canonicalString()}`;e.mightContain(c)||(this.Ue(t,i,null),s++)}),s}rt(e){const t=new Map;this.Be.forEach((i,a)=>{const c=this.Je(a);if(c){if(i.current&&ho(c.target)){const u=new U(c.target.path);this.ke.get(u)!==null||this.it(a,u)||this.Ue(a,u,ve.newNoDocument(u,e))}i.be&&(t.set(a,i.ve()),i.Ce())}});let r=K();this.qe.forEach((i,a)=>{let c=!0;a.forEachWhile(u=>{const d=this.Je(u);return!d||d.purpose==="TargetPurposeLimboResolution"||(c=!1,!1)}),c&&(r=r.add(i))}),this.ke.forEach((i,a)=>a.setReadTime(e));const s=new Ks(e,t,this.Qe,this.ke,r);return this.ke=Et(),this.qe=kl(),this.Qe=new ie(J),s}$e(e,t){if(!this.ze(e))return;const r=this.it(e,t.key)?2:0;this.Ge(e).Fe(t.key,r),this.ke=this.ke.insert(t.key,t),this.qe=this.qe.insert(t.key,this.st(t.key).add(e))}Ue(e,t,r){if(!this.ze(e))return;const s=this.Ge(e);this.it(e,t)?s.Fe(t,1):s.Me(t),this.qe=this.qe.insert(t,this.st(t).delete(e)),r&&(this.ke=this.ke.insert(t,r))}removeTarget(e){this.Be.delete(e)}Ye(e){const t=this.Ge(e).ve();return this.Le.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}xe(e){this.Ge(e).xe()}Ge(e){let t=this.Be.get(e);return t||(t=new Pl,this.Be.set(e,t)),t}st(e){let t=this.qe.get(e);return t||(t=new he(J),this.qe=this.qe.insert(e,t)),t}ze(e){const t=this.Je(e)!==null;return t||O("WatchChangeAggregator","Detected inactive target",e),t}Je(e){const t=this.Be.get(e);return t&&t.Se?null:this.Le.ot(e)}je(e){this.Be.set(e,new Pl),this.Le.getRemoteKeysForTarget(e).forEach(t=>{this.Ue(e,t,null)})}it(e,t){return this.Le.getRemoteKeysForTarget(e).has(t)}}function kl(){return new ie(U.comparator)}function Dl(){return new ie(U.comparator)}const Rv={asc:"ASCENDING",desc:"DESCENDING"},Pv={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},kv={and:"AND",or:"OR"};class Dv{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function go(n,e){return n.useProto3Json||Bs(e)?e:{value:e}}function Nv(n,e){return n.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function Lv(n,e){return n.useProto3Json?e.toBase64():e.toUint8Array()}function cn(n){return re(!!n),$.fromTimestamp(function(t){const r=It(t);return new be(r.seconds,r.nanos)}(n))}function Vv(n,e){return yo(n,e).canonicalString()}function yo(n,e){const t=function(s){return new ne(["projects",s.projectId,"databases",s.database])}(n).child("documents");return e===void 0?t:t.child(e)}function fd(n){const e=ne.fromString(n);return re(_d(e)),e}function Oi(n,e){const t=fd(e);if(t.get(1)!==n.databaseId.projectId)throw new F(N.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+t.get(1)+" vs "+n.databaseId.projectId);if(t.get(3)!==n.databaseId.database)throw new F(N.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+t.get(3)+" vs "+n.databaseId.database);return new U(md(t))}function pd(n,e){return Vv(n.databaseId,e)}function Mv(n){const e=fd(n);return e.length===4?ne.emptyPath():md(e)}function Nl(n){return new ne(["projects",n.databaseId.projectId,"databases",n.databaseId.database]).canonicalString()}function md(n){return re(n.length>4&&n.get(4)==="documents"),n.popFirst(5)}function Ov(n,e){let t;if("targetChange"in e){e.targetChange;const r=function(d){return d==="NO_CHANGE"?0:d==="ADD"?1:d==="REMOVE"?2:d==="CURRENT"?3:d==="RESET"?4:j()}(e.targetChange.targetChangeType||"NO_CHANGE"),s=e.targetChange.targetIds||[],i=function(d,f){return d.useProto3Json?(re(f===void 0||typeof f=="string"),de.fromBase64String(f||"")):(re(f===void 0||f instanceof Buffer||f instanceof Uint8Array),de.fromUint8Array(f||new Uint8Array))}(n,e.targetChange.resumeToken),a=e.targetChange.cause,c=a&&function(d){const f=d.code===void 0?N.UNKNOWN:ud(d.code);return new F(f,d.message||"")}(a);t=new dd(r,s,i,c||null)}else if("documentChange"in e){e.documentChange;const r=e.documentChange;r.document,r.document.name,r.document.updateTime;const s=Oi(n,r.document.name),i=cn(r.document.updateTime),a=r.document.createTime?cn(r.document.createTime):$.min(),c=new Ve({mapValue:{fields:r.document.fields}}),u=ve.newFoundDocument(s,i,a,c),d=r.targetIds||[],f=r.removedTargetIds||[];t=new ds(d,f,u.key,u)}else if("documentDelete"in e){e.documentDelete;const r=e.documentDelete;r.document;const s=Oi(n,r.document),i=r.readTime?cn(r.readTime):$.min(),a=ve.newNoDocument(s,i),c=r.removedTargetIds||[];t=new ds([],c,a.key,a)}else if("documentRemove"in e){e.documentRemove;const r=e.documentRemove;r.document;const s=Oi(n,r.document),i=r.removedTargetIds||[];t=new ds([],i,s,null)}else{if(!("filter"in e))return j();{e.filter;const r=e.filter;r.targetId;const{count:s=0,unchangedNames:i}=r,a=new Av(s,i),c=r.targetId;t=new hd(c,a)}}return t}function xv(n,e){return{documents:[pd(n,e.path)]}}function Fv(n,e){const t={structuredQuery:{}},r=e.path;let s;e.collectionGroup!==null?(s=r,t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(s=r.popLast(),t.structuredQuery.from=[{collectionId:r.lastSegment()}]),t.parent=pd(n,s);const i=function(d){if(d.length!==0)return yd(Be.create(d,"and"))}(e.filters);i&&(t.structuredQuery.where=i);const a=function(d){if(d.length!==0)return d.map(f=>function(I){return{field:tn(I.field),direction:$v(I.dir)}}(f))}(e.orderBy);a&&(t.structuredQuery.orderBy=a);const c=go(n,e.limit);return c!==null&&(t.structuredQuery.limit=c),e.startAt&&(t.structuredQuery.startAt=function(d){return{before:d.inclusive,values:d.position}}(e.startAt)),e.endAt&&(t.structuredQuery.endAt=function(d){return{before:!d.inclusive,values:d.position}}(e.endAt)),{_t:t,parent:s}}function Uv(n){let e=Mv(n.parent);const t=n.structuredQuery,r=t.from?t.from.length:0;let s=null;if(r>0){re(r===1);const f=t.from[0];f.allDescendants?s=f.collectionId:e=e.child(f.collectionId)}let i=[];t.where&&(i=function(y){const I=gd(y);return I instanceof Be&&Yh(I)?I.getFilters():[I]}(t.where));let a=[];t.orderBy&&(a=function(y){return y.map(I=>function(P){return new Cs(nn(P.field),function(k){switch(k){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(P.direction))}(I))}(t.orderBy));let c=null;t.limit&&(c=function(y){let I;return I=typeof y=="object"?y.value:y,Bs(I)?null:I}(t.limit));let u=null;t.startAt&&(u=function(y){const I=!!y.before,S=y.values||[];return new bs(S,I)}(t.startAt));let d=null;return t.endAt&&(d=function(y){const I=!y.before,S=y.values||[];return new bs(S,I)}(t.endAt)),sv(e,s,a,i,c,"F",u,d)}function Bv(n,e){const t=function(s){switch(s){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return j()}}(e.purpose);return t==null?null:{"goog-listen-tags":t}}function gd(n){return n.unaryFilter!==void 0?function(t){switch(t.unaryFilter.op){case"IS_NAN":const r=nn(t.unaryFilter.field);return ae.create(r,"==",{doubleValue:NaN});case"IS_NULL":const s=nn(t.unaryFilter.field);return ae.create(s,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const i=nn(t.unaryFilter.field);return ae.create(i,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const a=nn(t.unaryFilter.field);return ae.create(a,"!=",{nullValue:"NULL_VALUE"});default:return j()}}(n):n.fieldFilter!==void 0?function(t){return ae.create(nn(t.fieldFilter.field),function(s){switch(s){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";default:return j()}}(t.fieldFilter.op),t.fieldFilter.value)}(n):n.compositeFilter!==void 0?function(t){return Be.create(t.compositeFilter.filters.map(r=>gd(r)),function(s){switch(s){case"AND":return"and";case"OR":return"or";default:return j()}}(t.compositeFilter.op))}(n):j()}function $v(n){return Rv[n]}function Hv(n){return Pv[n]}function jv(n){return kv[n]}function tn(n){return{fieldPath:n.canonicalString()}}function nn(n){return Se.fromServerFormat(n.fieldPath)}function yd(n){return n instanceof ae?function(t){if(t.op==="=="){if(_l(t.value))return{unaryFilter:{field:tn(t.field),op:"IS_NAN"}};if(yl(t.value))return{unaryFilter:{field:tn(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if(_l(t.value))return{unaryFilter:{field:tn(t.field),op:"IS_NOT_NAN"}};if(yl(t.value))return{unaryFilter:{field:tn(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:tn(t.field),op:Hv(t.op),value:t.value}}}(n):n instanceof Be?function(t){const r=t.getFilters().map(s=>yd(s));return r.length===1?r[0]:{compositeFilter:{op:jv(t.op),filters:r}}}(n):j()}function _d(n){return n.length>=4&&n.get(0)==="projects"&&n.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qv{constructor(e){this.ct=e}}function zv(n){const e=Uv({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?fo(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Kv{constructor(){this.changes=new Sn(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,ve.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?R.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zv{constructor(){this.sessionToken=de.EMPTY_BYTE_STRING}getSessionToken(e){return R.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,R.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ta{constructor(){this.Tr=new he(ce.Er),this.dr=new he(ce.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,t){const r=new ce(e,t);this.Tr=this.Tr.add(r),this.dr=this.dr.add(r)}Rr(e,t){e.forEach(r=>this.addReference(r,t))}removeReference(e,t){this.Vr(new ce(e,t))}mr(e,t){e.forEach(r=>this.removeReference(r,t))}gr(e){const t=new U(new ne([])),r=new ce(t,e),s=new ce(t,e+1),i=[];return this.dr.forEachInRange([r,s],a=>{this.Vr(a),i.push(a.key)}),i}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){const t=new U(new ne([])),r=new ce(t,e),s=new ce(t,e+1);let i=K();return this.dr.forEachInRange([r,s],a=>{i=i.add(a.key)}),i}containsKey(e){const t=new ce(e,0),r=this.Tr.firstAfterOrEqual(t);return r!==null&&e.isEqual(r.key)}}class ce{constructor(e,t){this.key=e,this.wr=t}static Er(e,t){return U.comparator(e.key,t.key)||J(e.wr,t.wr)}static Ar(e,t){return J(e.wr,t.wr)||U.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ye="WebChannelConnection";class _I extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const r=t.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+t.host,this.vo=`projects/${s}/databases/${i}`,this.Co=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${i}`}get Fo(){return!1}Mo(t,r,s,i,a){const c=xi(),u=this.xo(t,r.toUriEncodedString());O("RestConnection",`Sending RPC '${t}' ${c}:`,u,s);const d={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(d,i,a),this.No(t,u,d,s).then(f=>(O("RestConnection",`Received RPC '${t}' ${c}: `,f),f),f=>{throw pn("RestConnection",`RPC '${t}' ${c} failed with error: `,f,"url: ",u,"request:",s),f})}Lo(t,r,s,i,a,c){return this.Mo(t,r,s,i,a)}Oo(t,r,s){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+An}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((i,a)=>t[a]=i),s&&s.headers.forEach((i,a)=>t[a]=i)}xo(t,r){const s=gI[t];return`${this.Do}/v1/${r}:${s}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,r,s){const i=xi();return new Promise((a,c)=>{const u=new $h;u.setWithCredentials(!0),u.listenOnce(Hh.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case us.NO_ERROR:const f=u.getResponseJson();O(ye,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(f)),a(f);break;case us.TIMEOUT:O(ye,`RPC '${e}' ${i} timed out`),c(new F(N.DEADLINE_EXCEEDED,"Request time out"));break;case us.HTTP_ERROR:const y=u.getStatus();if(O(ye,`RPC '${e}' ${i} failed with status:`,y,"response text:",u.getResponseText()),y>0){let I=u.getResponseJson();Array.isArray(I)&&(I=I[0]);const S=I==null?void 0:I.error;if(S&&S.status&&S.message){const P=function(k){const V=k.toLowerCase().replace(/_/g,"-");return Object.values(N).indexOf(V)>=0?V:N.UNKNOWN}(S.status);c(new F(P,S.message))}else c(new F(N.UNKNOWN,"Server responded with status "+u.getStatus()))}else c(new F(N.UNAVAILABLE,"Connection failed."));break;default:j()}}finally{O(ye,`RPC '${e}' ${i} completed.`)}});const d=JSON.stringify(s);O(ye,`RPC '${e}' ${i} sending request:`,s),u.send(t,"POST",d,r,15)})}Bo(e,t,r){const s=xi(),i=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=zh(),c=qh(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(u.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Oo(u.initMessageHeaders,t,r),u.encodeInitMessageHeaders=!0;const f=i.join("");O(ye,`Creating RPC '${e}' stream ${s}: ${f}`,u);const y=a.createWebChannel(f,u);let I=!1,S=!1;const P=new yI({Io:k=>{S?O(ye,`Not sending because RPC '${e}' stream ${s} is closed:`,k):(I||(O(ye,`Opening RPC '${e}' stream ${s} transport.`),y.open(),I=!0),O(ye,`RPC '${e}' stream ${s} sending:`,k),y.send(k))},To:()=>y.close()}),C=(k,V,H)=>{k.listen(V,q=>{try{H(q)}catch(L){setTimeout(()=>{throw L},0)}})};return C(y,Gn.EventType.OPEN,()=>{S||(O(ye,`RPC '${e}' stream ${s} transport opened.`),P.yo())}),C(y,Gn.EventType.CLOSE,()=>{S||(S=!0,O(ye,`RPC '${e}' stream ${s} transport closed`),P.So())}),C(y,Gn.EventType.ERROR,k=>{S||(S=!0,pn(ye,`RPC '${e}' stream ${s} transport errored:`,k),P.So(new F(N.UNAVAILABLE,"The operation could not be completed")))}),C(y,Gn.EventType.MESSAGE,k=>{var V;if(!S){const H=k.data[0];re(!!H);const q=H,L=q.error||((V=q[0])===null||V===void 0?void 0:V.error);if(L){O(ye,`RPC '${e}' stream ${s} received error:`,L);const x=L.status;let M=function(m){const v=oe[m];if(v!==void 0)return ud(v)}(x),E=L.message;M===void 0&&(M=N.INTERNAL,E="Unknown error status: "+x+" with message "+L.message),S=!0,P.So(new F(M,E)),y.close()}else O(ye,`RPC '${e}' stream ${s} received:`,H),P.bo(H)}}),C(c,jh.STAT_EVENT,k=>{k.stat===oo.PROXY?O(ye,`RPC '${e}' stream ${s} detected buffering proxy`):k.stat===oo.NOPROXY&&O(ye,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{P.wo()},0),P}}function Fi(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ns{constructor(e){this._byteString=e}static fromBase64String(e){try{return new Ns(de.fromBase64String(e))}catch(t){throw new F(N.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new Ns(de.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bd{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new F(N.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Se(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hE(n){n=un(n,Fe);const e=un(n.firestore,Ds);return QI(Ud(e),n._key).then(t=>zd(e,n,t))}class qd extends cE{constructor(e){super(),this.firestore=e}convertBytes(e){return new Ns(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Fe(this.firestore,null,t)}}function dE(n,...e){var t,r,s;n=Tt(n);let i={includeMetadataChanges:!1,source:"default"},a=0;typeof e[a]!="object"||Ql(e[a])||(i=e[a],a++);const c={includeMetadataChanges:i.includeMetadataChanges,source:i.source};if(Ql(e[a])){const y=e[a];e[a]=(t=y.next)===null||t===void 0?void 0:t.bind(y),e[a+1]=(r=y.error)===null||r===void 0?void 0:r.bind(y),e[a+2]=(s=y.complete)===null||s===void 0?void 0:s.bind(y)}let u,d,f;if(n instanceof Fe)d=un(n.firestore,Ds),f=js(n._key.path),u={next:y=>{e[a]&&e[a](zd(d,n,y))},error:e[a+1],complete:e[a+2]};else{const y=un(n,Js);d=un(y.firestore,Ds),f=y._query;const I=new qd(d);u={next:S=>{e[a]&&e[a](new lE(d,I,y,S))},error:e[a+1],complete:e[a+2]},aE(n._query)}return function(I,S,P,C){const k=new xd(C),V=new Pd(S,k,P);return I.asyncQueue.enqueueAndForget(async()=>Cd(await To(I),V)),()=>{k.Za(),I.asyncQueue.enqueueAndForget(async()=>Rd(await To(I),V))}}(Ud(d),f,c,u)}function zd(n,e,t){const r=t.docs.get(e._key),s=new qd(n);return new jd(n,s,e._key,r,new Qn(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){(function(s){An=s})(Tn),fn(new xt("firestore",(r,{instanceIdentifier:s,options:i})=>{const a=r.getProvider("app").getImmediate(),c=new Ds(new k_(r.getProvider("auth-internal")),new V_(r.getProvider("app-check-internal")),function(d,f){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new F(N.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new fr(d.options.projectId,f)}(a,s),a);return i=Object.assign({useFetchStreams:t},i),c._setSettings(i),c},"PUBLIC").setMultipleInstances(!0)),gt(dl,"4.7.3",e),gt(dl,"4.7.3","esm2017")})();const Gd="fenix_cloud_sync_config",wo={apiKey:"AIzaSyAvz0DRZIJLNHQsHmPg7LaUq9s3N2eEQtg",authDomain:"fenix-2c341.firebaseapp.com",projectId:"fenix-2c341",appId:"1:387287127608:web:c4e5aa07b3b91389c5b8cd",messagingSenderId:"387287127608",storageBucket:"fenix-2c341.firebasestorage.app"},Bi={enabled:!0,syncConsent:"granted",firebase:{...wo}},fE=30*60*1e3,pE="s11-vorax",Yl=`pricesSnapshots/${pE}`,Wd="fenix_price_last_sync_at";function ts(n){return typeof n=="number"&&Number.isFinite(n)?n:n instanceof be?n.toMillis():null}function mE(){try{const n=localStorage.getItem(Wd),e=n?Number(n):0;return Number.isFinite(e)?e:0}catch{return 0}}function Xl(n){try{localStorage.setItem(Wd,String(n))}catch(e){console.error("Failed to persist price sync timestamp:",e)}}function $i(){try{const n=localStorage.getItem(Gd);if(n){const e=JSON.parse(n),t={...Bi,...e,firebase:{...Bi.firebase,...e.firebase||{}}};return Kd(gE(t))}}catch(n){console.error("Failed to read cloud sync config:",n)}return{...Bi}}function gE(n){const e={...n.firebase};let t=!1;return Object.keys(wo).forEach(r=>{const s=e[r];(!s||String(s).trim()==="")&&(e[r]=wo[r],t=!0)}),t?{...n,firebase:e}:n}function Kd(n){let e=n.syncConsent,t=n.enabled;return e||(e="pending"),e==="pending"?t=!1:e==="granted"?t=!0:e==="denied"&&(t=!1),n.syncConsent===e&&n.enabled===t?n:{...n,syncConsent:e,enabled:t}}function Zl(n){try{localStorage.setItem(Gd,JSON.stringify(n))}catch(e){console.error("Failed to save cloud sync config:",e)}}function yE(n){const e=n.firebase;return!!e.apiKey&&!!e.authDomain&&!!e.projectId&&!!e.appId}class _E{constructor(){this.config=null,this.app=null,this.auth=null,this.db=null,this.lastSyncAt=0,this.lastSyncCache={},this.initializing=null,this.lastSyncCursorMs=null,this.snapshotUnsub=null,this.lastCacheUpdatedAt=null,this.lastCacheError=null}getSyncStatus(){this.config||(this.config=$i());const e=Kd(this.config);e!==this.config&&(this.config=e,Zl(this.config));const t=this.config.enabled===!0,r=this.config.syncConsent??"pending";return{enabled:t,consent:r}}async setSyncEnabled(e){this.config||(this.config=$i());const t=e?"granted":"denied";this.config.enabled=e,this.config.syncConsent=t,Zl(this.config),e&&await this.initialize()}async initialize(){if(this.initializing)return this.initializing;this.initializing=this.initializeInternal();const e=await this.initializing;return this.initializing=null,e}async initializeInternal(){if(this.config=$i(),typeof this.config.lastSyncCursorMs=="number"&&(this.lastSyncCursorMs=this.config.lastSyncCursorMs),!this.config.enabled)return!1;if(!yE(this.config))return console.warn("[sync] Firebase config missing. Sync disabled."),!1;if(this.app||(this.app=rh(this.config.firebase)),this.auth||(this.auth=b_(this.app)),this.db||(this.db=eE(this.app)),!this.auth.currentUser)try{await uy(this.auth)}catch(e){return console.error("Failed to sign in anonymously:",e),!1}return this.subscribeToSnapshot(),!0}async syncPrices(e){if(!await this.initialize()||!this.db)return{};const r=Date.now();if(this.lastSyncAt||(this.lastSyncAt=mE()),Object.keys(this.lastSyncCache).length===0&&(this.lastSyncCache=await Gu(),Object.keys(this.lastSyncCache).length>0)){const s=Object.values(this.lastSyncCache).map(i=>i.timestamp).filter(i=>typeof i=="number"&&Number.isFinite(i)).reduce((i,a)=>Math.max(i,a),0);this.lastCacheUpdatedAt=s||this.lastCacheUpdatedAt}if(!(e!=null&&e.forceFull)&&this.lastSyncAt&&r-this.lastSyncAt<fE)return this.lastSyncCache;try{const s=Wl(this.db,Yl),i=await hE(s);if(!i.exists())return this.lastCacheError="Price snapshot not available",this.lastSyncCache;const a=i.data(),c=a==null?void 0:a.data,u=ts(a==null?void 0:a.lastUpdated)??null,d={};if(c&&typeof c=="object")for(const[y,I]of Object.entries(c)){const S=typeof(I==null?void 0:I.price)=="number"?I.price:null,P=ts(I==null?void 0:I.timestamp);if(S===null||P===null)continue;const C=typeof(I==null?void 0:I.listingCount)=="number"?I.listingCount:void 0;d[y]={price:S,timestamp:P,...C!==void 0?{listingCount:C}:{}}}const f=await Mc(d);return this.lastSyncAt=r,Xl(r),this.lastSyncCache=f,this.lastCacheUpdatedAt=u,this.lastCacheError=null,f}catch(s){return console.error("Failed to sync prices from snapshot:",s),this.lastCacheError="Failed to read prices",this.lastSyncCache}}subscribeToSnapshot(){if(!this.db||this.snapshotUnsub)return;const e=Wl(this.db,Yl);this.snapshotUnsub=dE(e,async t=>{if(!t.exists())return;const r=t.data(),s=r==null?void 0:r.data,i=ts(r==null?void 0:r.lastUpdated)??null,a={};if(s&&typeof s=="object")for(const[u,d]of Object.entries(s)){const f=typeof(d==null?void 0:d.price)=="number"?d.price:null,y=ts(d==null?void 0:d.timestamp);if(f===null||y===null)continue;const I=typeof(d==null?void 0:d.listingCount)=="number"?d.listingCount:void 0;a[u]={price:f,timestamp:y,...I!==void 0?{listingCount:I}:{}}}const c=await Mc(a);this.lastSyncCache=c,this.lastSyncAt=Date.now(),Xl(this.lastSyncAt),this.lastCacheUpdatedAt=i,this.lastCacheError=null},t=>{console.error("Failed to subscribe to price snapshot:",t),this.lastCacheError="Failed to subscribe to price snapshot"})}getCacheStatus(){return{lastUpdated:this.lastCacheUpdatedAt,lastError:this.lastCacheError}}}let Ie=null,hn=null,Ce=null,eu=null,rr=null,Ls=0,sr=0,Ao=!1,Jn=!1,da=[],Qd=[];const Jd="fenix_inventory_cache";async function Yd(){hn=await zu(),Ce=new _E,await Ce.setSyncEnabled(!0);const n=await Gu(t=>Ce?Ce.syncPrices(t):Promise.resolve({}));Ie=new xp(hn,n);const e=localStorage.getItem(Jd);if(e&&Ie)try{const t=JSON.parse(e);Array.isArray(t)&&(Ie.hydrateInventory(t),So())}catch(t){console.warn("Failed to restore cached inventory:",t)}setInterval(async()=>{if(Ce){const t=await Ce.syncPrices();Ie&&(Ie.applyPriceCache(t),await No(Ie.getPriceCacheAsObject()),So())}},30*60*1e3),vE()}function vE(){eu||(eu=window.setInterval(()=>{Ls++,da.forEach(n=>n({type:"realtime",seconds:Ls}))},1e3))}function IE(){rr||(rr=window.setInterval(()=>{Ao&&!Jn&&(sr++,da.forEach(n=>n({type:"hourly",seconds:sr})))},1e3))}function EE(){rr&&(clearInterval(rr),rr=null)}function So(){Qd.forEach(n=>n())}const ee={async getInventory(){return Ie?Ie.getInventory().map(e=>e.baseId===En?{...e,price:1}:e):[]},async getItemDatabase(){return hn||(hn=await zu()),hn},async getPriceCache(){return Ie?Ie.getPriceCacheAsObject():{}},getPriceCacheStatus(){return Ce?Ce.getCacheStatus():{lastUpdated:null,lastError:"Price sync not initialized"}},onInventoryUpdate(n){Qd.push(n)},startHourlyTimer(){Ao=!0,Jn=!1,sr=0,IE()},pauseHourlyTimer(){Jn=!0},resumeHourlyTimer(){Jn=!1},stopHourlyTimer(){Ao=!1,Jn=!1,sr=0,EE()},resetRealtimeTimer(){Ls=0},async getTimerState(){return{realtimeSeconds:Ls,hourlySeconds:sr}},onTimerTick(n){da.push(n)},async getAppVersion(){return"2.4.0"},async checkForUpdates(){return{success:!1,message:"Updates not available in web version"}},onUpdateStatus(n){},onUpdateProgress(n){},onShowUpdateDialog(n){},onUpdateDownloadedTransition(n){},sendUpdateDialogResponse(n){},async isLogPathConfigured(){return localStorage.getItem("fenix_log_uploaded")==="true"},async selectLogFile(){return null},onShowLogPathSetup(n){},async getSettings(){return zp()},async saveSettings(n){try{return Gp(n),{success:!0}}catch(e){return{success:!1,error:e.message||"Failed to save settings"}}},async getUsernameInfo(){return{canChange:!1}},async setUsername(n){return{success:!1,error:"Username not supported in web version"}},async getCloudSyncStatus(){return Ce?Ce.getSyncStatus():{enabled:!1,consent:"pending"}},async setCloudSyncEnabled(n){if(!Ce)return{success:!1,error:"Price sync service not initialized"};try{return await Ce.setSyncEnabled(n),{success:!0}}catch(e){return{success:!1,error:e.message||"Failed to update cloud sync setting"}}},onShowSyncConsent(n){},async testKeybind(n){return{success:!1,error:"Keybinds not supported in web version"}},onCloseSettingsModal(n){},onWindowModeChanged(n){},minimizeWindow(){},maximizeWindow(){},closeWindow(){},onMaximizeStateChanged(n){},async getMaximizeState(){return!1},toggleOverlayWidget(){},updateOverlayWidget(n){},onWidgetPauseHourly(n){},onWidgetResumeHourly(n){}};async function tu(n){return new Promise((e,t)=>{const r=new FileReader;r.onload=async s=>{var i;try{const a=(i=s.target)==null?void 0:i.result,c=Kp(a);if((!Ie||!hn)&&await Yd(),Ie){if(Ie.buildInventory(c),Ce){const u=await Ce.syncPrices({forceFull:!0});Ie.applyPriceCache(u)}await No(Ie.getPriceCacheAsObject()),localStorage.setItem(Jd,JSON.stringify(Ie.getInventory())),localStorage.setItem("fenix_log_uploaded","true"),So(),e()}else t(new Error("Inventory manager not initialized"))}catch(a){t(a)}},r.onerror=()=>{t(new Error("Failed to read file"))},r.readAsText(n)})}let Xd=[],Zd={},ef="priceTotal",tf="desc",nf="",rf=null,sf=null,of=null;function $e(){return Xd}function Ys(){return Zd}function fa(){return ef}function pa(){return tf}function TE(){return nf}function af(){return rf}function cf(){return sf}function lf(){return of}function wE(n){Xd=n}function AE(n){Zd=n}function SE(n){ef=n}function nu(n){tf=n}function bE(n){nf=n}function ru(n){rf=n}function CE(n){sf=n}function RE(n){of=n}let uf="realtime",hf=[],df=[],ff=new Map,pf=0,mf=!1,gf=!1,yf=new Set,_f=null,vf=new Map,If=new Map,Ef=new Map,Tf=[],wf=0,Af=0,Sf=0,bf=!1;function De(){return uf}function su(n){uf=n}function ma(){return hf}function Cf(n){hf=n}function Cn(){return df}function gr(n){df=n}function br(){return ff}function PE(n){ff=n}function ga(){return pf}function Rf(n){pf=n}function wt(){return mf}function Pf(n){mf=n}function kf(){return gf}function Xs(n){gf=n}function ke(){return yf}function kE(n){yf=n}function DE(){return _f}function Df(n){_f=n}function Zs(){return vf}function NE(n){vf=n}function ya(){return If}function LE(n){If=n}function _a(){return Ef}function VE(n){Ef=n}function va(){return Tf}function ei(n){Tf=n}function Nf(){return wf}function Ia(n){wf=n}function ME(){return Af}function Lf(n){Af=n}function Vf(){return Sf}function Ea(n){Sf=n}function OE(){return bf}function xE(n){bf=n}let Mf=!0;function FE(){return Mf}function bo(n){Mf=n}function In(n){const e=Math.floor(n/3600).toString().padStart(2,"0"),t=Math.floor(n%3600/60).toString().padStart(2,"0"),r=(n%60).toString().padStart(2,"0");return`${e}:${t}:${r}`}function UE(n){return n==="none"?"Uncategorized":n.split("_").map(e=>e.charAt(0).toUpperCase()+e.slice(1).toLowerCase()).join(" ")}function Of(n){if(n===null)return"";const e=Date.now()-n;return e>=Vp?"price-very-stale":e>=Lp?"price-stale":""}function Ht(n,e=null){return!FE()||e===En?n:n*(1-Mp)}function Ta(n){const e=cf(),t=lf();if(n.price===null)return!(e!==null&&e>0);const r=n.price*n.totalQuantity,s=Ht(r,n.baseId);return!(e!==null&&s<e||t!==null&&s>t)}function ti(){return $e().reduce((e,t)=>{if(!Ta(t))return e;if(t.price!==null){const r=t.totalQuantity*t.price;return e+Ht(r,t.baseId)}return e},0)}function Cr(){const n=$e(),e=br(),t=ke(),r=cf(),s=lf();let i=0;for(const a of n){if(a.price===null||t.has(a.baseId))continue;const c=a.totalQuantity,u=e.get(a.baseId)||0,d=c-u;if(a.baseId===En){const f=d*a.price;i+=f}else{if(d<=0)continue;const f=d*a.price,y=Ht(f,a.baseId);if(r!==null&&y<r||s!==null&&y>s)continue;i+=y}}for(const a of t){const c=n.find(I=>I.baseId===a);if(!c||c.price===null)continue;const u=c.totalQuantity,f=(e.get(a)||0)-u;if(f===0)continue;const y=Math.abs(f)*c.price;f>0?i-=y:i+=y}return i}let xf,Ff,wa,Uf,ni;function BE(n,e,t,r,s){xf=n,Ff=e,wa=t,Uf=r,ni=s}function $E(){const n=ti();Lf(n),ni(n)}function HE(){Ea(0);const n=ti();Lf(n),Cf([]),ee.resetRealtimeTimer(),wa.textContent=In(0),ir(),ni(n)}function ir(){const n=ti(),e=Vf()/3600,t=ME(),r=e>0?(n-t)/e:0;ni(n),De()==="realtime"&&(xf.textContent=n.toFixed(2),Ff.textContent=r.toFixed(2)),Uf()}async function iu(){const n=await ee.getTimerState();Ea(n.realtimeSeconds),wa.textContent=In(n.realtimeSeconds)}let Bf,$f,Aa,Sa,ba,Rr,Pr,kr,Hf,jf,Ca,Ra;function jE(n,e,t,r,s,i,a,c,u,d,f,y){Bf=n,$f=e,Aa=t,Sa=r,ba=s,Rr=i,Pr=a,kr=c,Hf=u,jf=d,Ca=f,Ra=y}function qE(){Hf()}function qf(){const n=$e(),e=br(),t=Zs(),r=ya(),s=_a(),i=ke();e.clear(),t.clear(),r.clear(),s.clear();for(const a of n)e.set(a.baseId,a.totalQuantity),i.has(a.baseId)&&t.set(a.baseId,a.totalQuantity);if(gr([]),ei([]),Ia(0),De()==="hourly"){const a=Cn();a.push({time:Date.now(),value:0}),gr(a)}Sa.style.display="none",ba.style.display="inline-block",Rr.style.display="inline-block",Pr.style.display="none",Aa.textContent="00:00:00",Pf(!0),Xs(!1),ee.startHourlyTimer(),or(),Ca(),Ra()}function zE(){const n=$e(),e=ke(),t=Zs(),r=br(),s=ya(),i=_a();for(const a of e){const c=n.find(f=>f.baseId===a),u=c?c.totalQuantity:0,d=t.get(a)??r.get(a)??u;if(r.get(a),u<d){const f=d-u,y=s.get(a)||0;s.set(a,y+f)}if(u>d){const f=u-d,y=i.get(a)||0;i.set(a,y+f)}}}function Pa(){const n=$e(),e=ke(),t=Zs();for(const r of e){const s=n.find(i=>i.baseId===r);s&&t.set(r,s.totalQuantity)}}function GE(){const n=Cr(),e=Math.floor(ga()/3600),t=Nf(),r=Cn(),s=va(),i=ke(),a=$e(),c=Zs(),u=ya(),d=_a(),f={hourNumber:e,startValue:t,endValue:n,earnings:n-t,history:[...r]};s.push(f),ei(s),Ia(n),gr([{time:Date.now(),value:n}]),u.clear(),d.clear();for(const I of i){const S=a.find(P=>P.baseId===I);S&&c.set(I,S.totalQuantity)}const y=document.querySelector(".stats-container");if(y){const I=document.createElement("div");I.className="earnings-animation",I.textContent=`Hour ${e} Complete! +${f.earnings.toFixed(2)} FE`,I.style.color="#10b981",y.appendChild(I),setTimeout(()=>I.remove(),2e3)}}function WE(){Xs(!0),ee.pauseHourlyTimer(),Pa(),Rr.style.display="none",Pr.style.display="inline-block",kr()}function KE(){Xs(!1),ee.resumeHourlyTimer(),Pa(),Rr.style.display="inline-block",Pr.style.display="none",kr()}function QE(){ee.stopHourlyTimer();const n=Cr(),e=va(),t=Cn(),r=Nf(),i={hourNumber:e.length+1,startValue:r,endValue:n,earnings:n-r,history:[...t]};e.push(i),ei(e),jf(),Sa.style.display="inline-block",ba.style.display="none",Rr.style.display="none",Pr.style.display="none",Aa.textContent="00:00:00",Rf(0),Pf(!1),Xs(!1),Ca(),Ra(),kr()}function or(){const n=Cr(),e=ga()/3600,t=e>0?n/e:0;De()==="hourly"&&(Bf.textContent=n.toFixed(2),$f.textContent=t.toFixed(2)),kr()}function zf(){const n=$e(),e=De(),t=wt();if(e==="hourly"&&t){const r=br(),s=ke();return n.filter(i=>!s.has(i.baseId)).map(i=>{const a=i.totalQuantity,c=r.get(i.baseId)||0,u=a-c;return{...i,totalQuantity:u}}).filter(i=>i.baseId===En?!0:i.totalQuantity>0)}return n}function JE(){const n=zf(),e=TE(),t=af(),r=Ys(),s=fa(),i=pa();let a=n.filter(c=>{if(e&&!c.itemName.toLowerCase().includes(e.toLowerCase()))return!1;if(t!==null){const u=r[c.baseId];if(((u==null?void 0:u.group)||"none")!==t)return!1}return Ta(c)});return a.sort((c,u)=>{let d=0;if(s==="priceUnit"){const f=c.price??-1,y=u.price??-1;d=f-y}else if(s==="priceTotal"){const f=Ht((c.price??0)*c.totalQuantity,c.baseId),y=Ht((u.price??0)*u.totalQuantity,u.baseId);d=f-y}return i==="asc"?d:-d}),a}function YE(n){if(n.pageId===null||n.slotId===null)return"";const e=n.pageId===102?"P1":n.pageId===103?"P2":`P${n.pageId}`,t=n.slotId+1;return`${e}:${t}`}function XE(){const n=document.getElementById("usageSection"),e=document.getElementById("usageContent");if(!n||!e)return;const t=De(),r=wt(),s=ke();if(t==="hourly"&&r&&s.size>0){n.style.display="block";const i=$e(),a=br(),c=Ys(),u=[];for(const f of s){const y=i.find(C=>C.baseId===f),I=y?y.totalQuantity:0,P=(a.get(f)||0)-I;if(!y){const C=c[f];C&&u.push({baseId:f,itemName:C.name,netUsage:P,price:0});continue}u.push({baseId:f,itemName:y.itemName,netUsage:P,price:y.price||0})}if(u.length===0){n.style.display="none";return}u.sort((f,y)=>{const I=f.price>0?Math.abs(f.netUsage*f.price):0;return(y.price>0?Math.abs(y.netUsage*y.price):0)-I});let d=0;e.innerHTML=u.map(({baseId:f,itemName:y,netUsage:I,price:S})=>{const P=S>0?S:0,C=S>0?Math.abs(I)*S:0;I>0?d-=C:I<0&&(d+=C);const k=I>0?"-":I<0?"+":"",V=I!==0?`${k}${Math.abs(I)}`:"0",H=I>0?"-":I<0?"+":"",q=S>0&&I!==0?`${H}${C.toFixed(2)} FE`:"- FE";return`
        <div class="item-row">
          <div class="item-name">
...
<span class="price-help-icon">
  ...
  `}function CT(n){const e=document.createElement("div");return e.textContent=n,e.innerHTML}function RT(n,e,t){return[...n].sort((s,i)=>{let a,c;switch(e){case"name":a=s.name.toLowerCase(),c=i.name.toLowerCase();break;case"price":a=s.price,c=i.price;break;case"trend":a=s.trendPercent,c=i.trendPercent;break;default:return 0}return a<c?t==="asc"?-1:1:a>c?t==="asc"?1:-1:0})}function ri(){const n=document.getElementById("pricesTableBody");if(!n)return;const e=RT(Yf,ko,Yn),t=document.getElementById("pricesItemCount");t&&(t.textContent=`${e.length} item${e.length!==1?"s":""}`),n.innerHTML=e.map((r,s)=>bT(r)).join(""),setTimeout(()=>{e.forEach(r=>{const s=document.getElementById(`sparkline-${r.baseId}`);if(s){const i=s.getAttribute("data-prices"),a=s.getAttribute("data-trend");if(i){const c=i.split(",").map(u=>parseFloat(u));TT(s,c,a)}}})},0)}async function Ji(){try{const[n,e]=await Promise.all([ee.getPriceCache(),ee.getItemDatabase()]);Ou=e,xu=n,Jf=Object.entries(Ou).map(([s,i])=>{if(s===En||i.tradable===!1)return null;const a=i.name||`Unknown Item (${s})`,c=xu[s],u=(c==null?void 0:c.price)??0,d=(c==null?void 0:c.timestamp)??Date.now(),f=c==null?void 0:c.listingCount,y=c==null?void 0:c.history,I=u>0?ET(y,u,d):{trend:"neutral",percent:0};return{baseId:s,name:a,price:u,timestamp:d,listingCount:f,trend:I.trend,trendPercent:I.percent,group:i.group,history:y}}).filter(s=>s!==null).sort((s,i)=>s.name.localeCompare(i.name)),Va(),ri(),Fu(),setInterval(Fu,60*1e3)}catch(n){console.error("Failed to load prices:",n)}}function Va(){let n=[...Jf];if(Po){const e=Po.toLowerCase();n=n.filter(t=>t.name.toLowerCase().includes(e)||t.baseId.toLowerCase().includes(e))}else Ro!=="all"&&(n=n.filter(e=>e.group===Ro));Yf=n}function Uu(n){Po=n.trim(),Va(),ri()}function PT(n){Ro=n,document.querySelectorAll(".prices-sidebar-item").forEach(e=>{e.classList.remove("active"),e.getAttribute("data-group")===n&&e.classList.add("active")}),Va(),ri()}function kT(n){ko===n?Yn=Yn==="asc"?"desc":"asc":(ko=n,Yn="asc"),document.querySelectorAll(".prices-table th").forEach(e=>{e.classList.remove("sort-asc","sort-desc"),e.getAttribute("data-sort")===n&&e.classList.add(`sort-${Yn}`)}),ri()}function DT(){const n=document.getElementById("pricesSearchInput"),e=document.getElementById("pricesClearSearch"),t=document.querySelectorAll(".prices-table th[data-sort]");n&&n.addEventListener("input",i=>{const a=i.target.value;Uu(a),e&&(e.style.display=a?"block":"none")}),e&&e.addEventListener("click",()=>{n&&(n.value="",Uu(""),e.style.display="none")}),t.forEach(i=>{i.addEventListener("click",()=>{const a=i.getAttribute("data-sort");a&&kT(a)})}),document.querySelectorAll(".prices-sidebar-item").forEach(i=>{i.addEventListener("click",()=>{const a=i.getAttribute("data-group");a&&PT(a)})});const s=document.getElementById("page-prices");s&&new MutationObserver(a=>{a.forEach(c=>{c.type==="attributes"&&c.attributeName==="class"&&s.classList.contains("active")&&Ji()})}).observe(s,{attributes:!0}),s!=null&&s.classList.contains("active")&&Ji(),ee.onInventoryUpdate(()=>{const i=document.getElementById("page-prices");i!=null&&i.classList.contains("active")&&Ji()})}function Yi(){const n=De(),e=wt();n==="hourly"&&e?Cr():ti()}function Xf(n){ir(),wt()&&!kf()&&or(),Ge(Ae)}async function Bu(){const[n,e]=await Promise.all([ee.getInventory(),ee.getItemDatabase()]);AE(e);const t=n.map(r=>r.baseId===En?{...r,price:1}:r);wE(t),OE()||($E(),xE(!0)),wt()&&!kf()&&zE(),Pa(),Ae(),Xf(),Ge(Ae)}async function NT(){gT(),eT(),rT(Ae,()=>Ge(Ae)),fT(),pT();const n=mT();hT(Ae,()=>Ge(Ae),Xf,n),BE(_u,vu,cr,Yi,tT),jE(_u,vu,Iu,ka,Da,Na,La,Yi,ou,sT,Ae,()=>Ge(Ae)),yT(Ae,()=>Ge(Ae),ir,or),_T(qE,QE,WE,KE,HE,ir,or,Ae,()=>Ge(Ae),Vs,Yi,ou,aT,cT,Qf,lT,qf,iT),vT(),DT(),ee.onTimerTick(r=>{if(r.type==="realtime")Ea(r.seconds),De()==="realtime"&&(cr.textContent=In(r.seconds)),ir();else if(r.type==="hourly"){Rf(r.seconds),Iu.textContent=In(r.seconds);const s=Cr();if(De()==="hourly"){const i=Cn();i.push({time:Date.now(),value:s}),gr(i),Vs()}or(),Ae(),Ge(Ae),r.seconds%3600===0&&r.seconds>0&&GE()}}),ee.onInventoryUpdate(()=>{Bu()});const[e,t]=await Promise.all([ee.getSettings(),ee.isLogPathConfigured()]);bo(e.includeTax!==void 0?e.includeTax:!1),t?(await Bu(),await iu()):await iu(),Gf()}async function $u(){await Yd(),await NT()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",$u):$u();
