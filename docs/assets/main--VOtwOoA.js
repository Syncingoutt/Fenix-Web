 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Im="FirebaseError";class et extends Error{constructor(e,t,r){super(t),this.code=e,this.customData=r,this.name=Im,Object.setPrototypeOf(this,et.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,wr.prototype.create)}}class wr{constructor(e,t,r){this.service=e,this.serviceName=t,this.errors=r}create(e,...t){const r=t[0]||{},s=`${this.service}/${e}`,i=this.errors[e],a=i?Em(i,r):"Error",c=`${this.serviceName}: ${a} (${s}).`;return new et(s,c,r)}}function Em(n,e){return n.replace(Tm,(t,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const Tm=/\{\$([^}]+)}/g;function wm(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}function Ss(n,e){if(n===e)return!0;const t=Object.keys(n),r=Object.keys(e);for(const s of t){if(!r.includes(s))return!1;const i=n[s],a=e[s];if(tl(i)&&tl(a)){if(!Ss(i,a))return!1}else if(i!==a)return!1}for(const s of r)if(!t.includes(s))return!1;return!0}function tl(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var H;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(H||(H={}));const Dm={debug:H.DEBUG,verbose:H.VERBOSE,info:H.INFO,warn:H.WARN,error:H.ERROR,silent:H.SILENT},Nm=H.INFO,Vm={[H.DEBUG]:"log",[H.VERBOSE]:"log",[H.INFO]:"info",[H.WARN]:"warn",[H.ERROR]:"error"},Lm=(n,e,...t)=>{if(e<n.logLevel)return;const r=new Date().toISOString(),s=Vm[e];if(s)console[s](`[${r}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class Uo{constructor(e){this.name=e,this._logLevel=Nm,this._logHandler=Lm,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in H))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Dm[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,H.DEBUG,...e),this._logHandler(this,H.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,H.VERBOSE,...e),this._logHandler(this,H.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,H.INFO,...e),this._logHandler(this,H.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,H.WARN,...e),this._logHandler(this,H.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,H.ERROR,...e),this._logHandler(this,H.ERROR,...e)}}const Mm=(n,e)=>e.some(t=>n instanceof t);let nl,rl;function Om(){return nl||(nl=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function xm(){return rl||(rl=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const uh=new WeakMap,oo=new WeakMap,hh=new WeakMap,xi=new WeakMap,Bo=new WeakMap;function Fm(n){const e=new Promise((t,r)=>{const s=()=>{n.removeEventListener("success",i),n.removeEventListener("error",a)},i=()=>{t(yt(n.result)),s()},a=()=>{r(n.error),s()};n.addEventListener("success",i),n.addEventListener("error",a)});return e.then(t=>{t instanceof IDBCursor&&uh.set(t,n)}).catch(()=>{}),Bo.set(e,n),e}function Um(n){if(oo.has(n))return;const e=new Promise((t,r)=>{const s=()=>{n.removeEventListener("complete",i),n.removeEventListener("error",a),n.removeEventListener("abort",a)},i=()=>{t(),s()},a=()=>{r(n.error||new DOMException("AbortError","AbortError")),s()};n.addEventListener("complete",i),n.addEventListener("error",a),n.addEventListener("abort",a)});oo.set(n,e)}let ao={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return oo.get(n);if(e==="objectStoreNames")return n.objectStoreNames||hh.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return yt(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function Bm(n){ao=n(ao)}function $m(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const r=n.call(Fi(this),e,...t);return hh.set(r,e.sort?e.sort():[e]),yt(r)}:xm().includes(n)?function(...e){return n.apply(Fi(this),e),yt(uh.get(this))}:function(...e){return yt(n.apply(Fi(this),e))}}function qm(n){return typeof n=="function"?$m(n):(n instanceof IDBTransaction&&Um(n),Mm(n,Om())?new Proxy(n,ao):n)}function yt(n){if(n instanceof IDBRequest)return Fm(n);if(xi.has(n))return xi.get(n);const e=qm(n);return e!==n&&(xi.set(n,e),Bo.set(e,n)),e}const Fi=n=>Bo.get(n);function jm(n,e,{blocked:t,upgrade:r,blocking:s,terminated:i}={}){const a=indexedDB.open(n,e),c=yt(a);return r&&a.addEventListener("upgradeneeded",u=>{r(yt(a.result),u.oldVersion,u.newVersion,yt(a.transaction),u)}),t&&a.addEventListener("blocked",u=>t(u.oldVersion,u.newVersion,u)),c.then(u=>{i&&u.addEventListener("close",()=>i()),s&&u.addEventListener("versionchange",d=>s(d.oldVersion,d.newVersion,d))}).catch(()=>{}),c}const Hm=["get","getKey","getAll","getAllKeys","count"],zm=["put","add","delete","clear"],Ui=new Map;function sl(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(Ui.get(e))return Ui.get(e);const t=e.replace(/FromIndex$/,""),r=e!==t,s=zm.includes(t);if(!(t in(r?IDBIndex:IDBObjectStore).prototype)||!(s||Hm.includes(t)))return;const i=async function(a,...c){const u=this.transaction(a,s?"readwrite":"readonly");let d=u.store;return r&&(d=d.index(c.shift())),(await Promise.all([d[t](...c),s&&u.done]))[0]};return Ui.set(e,i),i}Bm(n=>({...n,get:(e,t,r)=>sl(e,t)||n.get(e,t,r),has:(e,t)=>!!sl(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gm{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Wm(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function Wm(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const co="@firebase/app",il="0.10.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cs=new Map,Tg=new Map,uo=new Map;function ol(n,e){try{n.container.addComponent(e)}catch(t){Je.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function pn(n){const e=n.name;if(uo.has(e))return Je.debug(`There were multiple attempts to register component ${e}.`),!1;uo.set(e,n);for(const t of Cs.values())ol(t,n);for(const t of Tg.values())ol(t,n);return!0}function $o(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function Ge(n){return n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sn=Ig;function dh(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r=Object.assign({name:lo,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw _t.create("bad-app-name",{appName:String(s)});if(t||(t=ch()),!t)throw _t.create("no-options");const i=Cs.get(s);if(i){if(Ss(t,i.options)&&Ss(r,i.config))return i;throw _t.create("duplicate-app",{appName:s})}const a=new km(s);for(const u of uo.values())a.addComponent(u);const c=new Ag(t,r,a);return Cs.set(s,c),c}function fh(n=lo){const e=Cs.get(n);if(!e&&n===lo&&ch())return dh();if(!e)throw _t.create("no-app",{appName:n});return e}function vt(n,e,t){var r;let s=(r=Eg[n])!==null&&r!==void 0?r:n;t&&(s+=`-${t}`);const i=s.match(/\s|\//),a=e.match(/\s|\//);if(i||a){const c=[`Unable to register library "${s}" with version "${e}":`];i&&c.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&a&&c.push("and"),a&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Je.warn(c.join(" "));return}pn(new xt(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bg="firebase-heartbeat-database",Sg=1,mr="firebase-heartbeat-store";let Bi=null;function ph(){return Bi||(Bi=jm(bg,Sg,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(mr)}catch(t){console.warn(t)}}}}).catch(n=>{throw _t.create("idb-open",{originalErrorMessage:n.message})})),Bi}async function Cg(n){try{const t=(await ph()).transaction(mr),r=await t.objectStore(mr).get(mh(n));return await t.done,r}catch(e){if(e instanceof et)Je.warn(e.message);else{const t=_t.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Je.warn(t.message)}}}async function al(n,e){try{const r=(await ph()).transaction(mr,"readwrite");await r.objectStore(mr).put(e,mh(n)),await r.done}catch(t){if(t instanceof et)Je.warn(t.message);else{const r=_t.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});Je.warn(r.message)}}}function mh(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vg(n){pn(new xt("platform-logger",e=>new Gm(e),"PRIVATE")),pn(new xt("heartbeat",e=>new kg(e),"PRIVATE")),vt(co,il,n),vt(co,il,"esm2017"),vt("fire-js","")}Vg("");var Lg="firebase",Mg="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */vt(Lg,Mg,"app");function qo(n,e){var t={};for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&e.indexOf(r)<0&&(t[r]=n[r]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var s=0,r=Object.getOwnPropertySymbols(n);s<r.length;s++)e.indexOf(r[s])<0&&Object.prototype.propertyIsEnumerable.call(n,r[s])&&(t[r[s]]=n[r[s]]);return t}function gh(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Og=gh,yh=new wr("auth","Firebase",gh());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rs=new Uo("@firebase/auth");function xg(n,...e){Rs.logLevel<=H.WARN&&Rs.warn(`Auth (${Sn}): ${n}`,...e)}function fs(n,...e){Rs.logLevel<=H.ERROR&&Rs.error(`Auth (${Sn}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ho(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.href)||""}function Fg(){return ul()==="http:"||ul()==="https:"}function ul(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class br{constructor(e,t){this.shortDelay=e,this.longDelay=t,Xe(t>e,"Short delay should be less than long delay!"),this.isMobile=hm()||mm()}get(){return Ug()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qg=new br(3e4,6e4);function qs(n,e){return n.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:n.tenantId}):e}async function Cn(n,e,t,r,s={}){return Ih(n,s,async()=>{let i={},a={};r&&(e==="GET"?a=r:i={body:JSON.stringify(r)});const c=Ar(Object.assign({key:n.config.apiKey},a)).slice(1),u=await n._getAdditionalHeaders();u["Content-Type"]="application/json",n.languageCode&&(u["X-Firebase-Locale"]=n.languageCode);const d=Object.assign({method:e,headers:u},i);return fm()||(d.referrerPolicy="no-referrer"),vh.fetch()(Th(n,n.config.apiHost,t,c),d)})}async function Ih(n,e,t){n._canInitEmulator=!1;const r=Object.assign(Object.assign({},$g),e);try{const s=new jg(n),i=await Promise.race([t(),s.promise]);s.clearNetworkTimeout();const a=await i.json();if("needConfirmation"in a)throw rs(n,"account-exists-with-different-credential",a);if(i.ok&&!("errorMessage"in a))return a;{const c=i.ok?a.errorMessage:a.error.message,[u,d]=c.split(" : ");if(u==="FEDERATED_USER_ID_ALREADY_LINKED")throw rs(n,"credential-already-in-use",a);if(u==="EMAIL_EXISTS")throw rs(n,"email-already-in-use",a);if(u==="USER_DISABLED")throw rs(n,"user-disabled",a);const f=r[u]||u.toLowerCase().replace(/[_\s]+/g,"-");if(d)throw _h(n,f,d);Ye(n,f)}}catch(s){if(s instanceof et)throw s;Ye(n,"network-request-failed",{message:String(s)})}}async function Eh(n,e,t,r,s={}){const i=await Cn(n,e,t,r,s);return"mfaPendingCredential"in i&&Ye(n,"multi-factor-auth-required",{_serverResponse:i}),i}function Th(n,e,t,r){const s=`${e}${t}?${r}`;return n.config.emulator?Ho(n.config,s):`${n.config.apiScheme}://${s}`}class jg{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,r)=>{this.timer=setTimeout(()=>r(Oe(this.auth,"network-request-failed")),qg.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function rs(n,e,t){const r={appName:n.name};t.email&&(r.email=t.email),t.phoneNumber&&(r.phoneNumber=t.phoneNumber);const s=Oe(n,e,r);return s.customData._tokenResponse=t,s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function gr(n,e,t=!1){if(t)return e;try{return await e}catch(r){throw r instanceof et&&Gg(r)&&n.auth.currentUser===n&&await n.auth.signOut(),r}}function Gg({code:n}){return n==="auth/user-disabled"||n==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ps(n){var e;const t=n.auth,r=await n.getIdToken(),s=await gr(n,wh(t,{idToken:r}));B(s==null?void 0:s.users.length,t,"internal-error");const i=s.users[0];n._notifyReloadListener(i);const a=!((e=i.providerUserInfo)===null||e===void 0)&&e.length?Ah(i.providerUserInfo):[],c=Qg(n.providerData,a),u=n.isAnonymous,d=!(n.email&&i.passwordHash)&&!(c!=null&&c.length),f=u?d:!1,g={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:c,metadata:new fo(i.createdAt,i.lastLoginAt),isAnonymous:f};Object.assign(n,g)}async function Kg(n){const e=Ve(n);await Ps(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Qg(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function Ah(n){return n.map(e=>{var{providerId:t}=e,r=qo(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Jg(n,e){const t=await Ih(n,{},async()=>{const r=Ar({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:i}=n.config,a=Th(n,s,"/v1/token",`key=${i}`),c=await n._getAdditionalHeaders();return c["Content-Type"]="application/x-www-form-urlencoded",vh.fetch()(a,{method:"POST",headers:c,body:r})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function Yg(n,e){return Cn(n,"POST","/v2/accounts:revokeToken",qs(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ty(n,e={}){return Cn(n,"GET","/v2/passwordPolicy",qs(n,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ly(n,e){const t=$o(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(Ss(i,e??{}))return s;Ye(s,"already-initialized")}return t.initialize({options:e})}function uy(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(Qe);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function hy(n,e,t){const r=js(n);B(r._canInitEmulator,r,"emulator-config-failed"),B(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,i=Mh(e),{host:a,port:c}=dy(e),u=c===null?"":`:${c}`;r.config.emulator={url:`${i}//${a}${u}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:a,port:c,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})}),fy()}function Mh(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function dy(n){const e=Mh(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:gl(r.substr(i.length+1))}}else{const[i,a]=r.split(":");return{host:i,port:gl(a)}}}function gl(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function fy(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cn(n,e){return Eh(n,"POST","/v1/accounts:signInWithIdp",qs(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sr extends xh{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ht extends Sr{constructor(){super("facebook.com")}static credential(e){return Ft._fromParams({providerId:ht.PROVIDER_ID,signInMethod:ht.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return ht.credentialFromTaggedObject(e)}static credentialFromError(e){return ht.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return ht.credential(e.oauthAccessToken)}catch{return null}}}ht.FACEBOOK_SIGN_IN_METHOD="facebook.com";ht.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dt extends Sr{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return Ft._fromParams({providerId:dt.PROVIDER_ID,signInMethod:dt.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return dt.credentialFromTaggedObject(e)}static credentialFromError(e){return dt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:r}=e;if(!t&&!r)return null;try{return dt.credential(t,r)}catch{return null}}}dt.GOOGLE_SIGN_IN_METHOD="google.com";dt.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ft extends Sr{constructor(){super("github.com")}static credential(e){return Ft._fromParams({providerId:ft.PROVIDER_ID,signInMethod:ft.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return ft.credentialFromTaggedObject(e)}static credentialFromError(e){return ft.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return ft.credential(e.oauthAccessToken)}catch{return null}}}ft.GITHUB_SIGN_IN_METHOD="github.com";ft.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pt extends Sr{constructor(){super("twitter.com")}static credential(e,t){return Ft._fromParams({providerId:pt.PROVIDER_ID,signInMethod:pt.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return pt.credentialFromTaggedObject(e)}static credentialFromError(e){return pt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:r}=e;if(!t||!r)return null;try{return pt.credential(t,r)}catch{return null}}}pt.TWITTER_SIGN_IN_METHOD="twitter.com";pt.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function my(n,e){return Eh(n,"POST","/v1/accounts:signUp",qs(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ks extends et{constructor(e,t,r,s){var i;super(t.code,t.message),this.operationType=r,this.user=s,Object.setPrototypeOf(this,ks.prototype),this.customData={appName:e.name,tenantId:(i=e.tenantId)!==null&&i!==void 0?i:void 0,_serverResponse:t.customData._serverResponse,operationType:r}}static _fromErrorAndOperation(e,t,r,s){return new ks(e,t,r,s)}}function Fh(n,e,t,r){return(e==="reauthenticate"?t._getReauthenticationResolver(n):t._getIdTokenResponse(n)).catch(i=>{throw i.code==="auth/multi-factor-auth-required"?ks._fromErrorAndOperation(n,i,e,r):i})}async function yy(n,e,t=!1){const r=await gr(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return Et._forOperation(n,"link",r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qy="pendingRedirect",ms=new Map;class jy extends Wh{constructor(e,t,r=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,r),this.eventId=null}async execute(){let e=ms.get(this.auth._key());if(!e){try{const r=await Hy(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(r)}catch(t){e=()=>Promise.reject(t)}ms.set(this.auth._key(),e)}return this.bypassAuthState||ms.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Hy(n,e){const t=Wy(e),r=Gy(n);if(!await r._isAvailable())return!1;const s=await r._get(t)==="true";return await r._remove(t),s}function zy(n,e){ms.set(n._key(),e)}function Gy(n){return Qe(n._redirectPersistence)}function Wy(n){return ps(qy,n.config.apiKey,n.name)}async function Ky(n,e,t=!1){if(Ge(n.app))return Promise.reject(It(n));const r=js(n),s=xy(r,e),a=await new jy(r,s,t).execute();return a&&!t&&(delete a.user._redirectEventId,await r._persistUserIfCurrent(a.user),await r._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const r_=new br(3e4,6e4);function El(){const n=xe().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function s_(n){return new Promise((e,t)=>{var r,s,i;function a(){El(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{El(),t(Oe(n,"network-request-failed"))},timeout:r_.get()})}if(!((s=(r=xe().gapi)===null||r===void 0?void 0:r.iframes)===null||s===void 0)&&s.Iframe)e(gapi.iframes.getContext());else if(!((i=xe().gapi)===null||i===void 0)&&i.load)a();else{const c=cy("iframefcb");return xe()[c]=()=>{gapi.load?a():t(Oe(n,"network-request-failed"))},oy(`${ay()}?onload=${c}`).catch(u=>t(u))}}).catch(e=>{throw gs=null,e})}let gs=null;function i_(n){return gs=gs||s_(n),gs}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const o_=new br(5e3,15e3),a_="__/auth/iframe",c_="emulator/auth/iframe",l_={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},u_=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function h_(n){const e=n.config;B(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?Ho(e,c_):`https://${n.config.authDomain}/${a_}`,r={apiKey:e.apiKey,appName:n.name,v:Sn},s=u_.get(n.config.apiHost);s&&(r.eid=s);const i=n._getFrameworks();return i.length&&(r.fw=i.join(",")),`${t}?${Ar(r).slice(1)}`}async function d_(n){const e=await i_(n),t=xe().gapi;return B(t,n,"internal-error"),e.open({where:document.body,url:h_(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:l_,dontclear:!0},r=>new Promise(async(s,i)=>{await r.restyle({setHideOnLeave:!1});const a=Oe(n,"network-request-failed"),c=xe().setTimeout(()=>{i(a)},o_.get());function u(){xe().clearTimeout(c),s(r)}r.ping(u).then(u,()=>{i(a)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qi="webStorageSupport";class A_{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=qh,this._completeRedirectFn=Ky,this._overrideRedirectResult=zy}async _openPopup(e,t,r,s){var i;Xe((i=this.eventManagers[e._key()])===null||i===void 0?void 0:i.manager,"_initialize() not called before _openPopup()");const a=await wl(e,t,r,ho(),s);return __(e,a,Ko())}async _openRedirect(e,t,r,s){await this._originValidation(e);const i=await wl(e,t,r,ho(),s);return Cy(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:i}=this.eventManagers[t];return s?Promise.resolve(s):(Xe(i,"If manager is not set, promise should be"),i)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await d_(e),r=new Jy(e);return t.register("authEvent",s=>(B(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(qi,{type:qi},s=>{var i;const a=(i=s==null?void 0:s[0])===null||i===void 0?void 0:i[qi];a!==void 0&&t(!!a),Ye(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=t_(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Vh()||Ch()||Go()}}const b_=A_;var Al="@firebase/auth",bl="1.7.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xo{constructor(e,t){this.previousValue=e,t&&(t.sequenceNumberHandler=r=>this.ie(r),this.se=r=>t.writeSequenceNumber(r))}ie(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.se&&this.se(e),e}}Xo.oe=-1;function Gs(n){return n==null}function Vs(n){return n===0&&1/n==-1/0}function J_(n){return typeof n=="number"&&Number.isInteger(n)&&!Vs(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pl(n){let e=0;for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e++;return e}function Pr(n,e){for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e(t,n[t])}function nd(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ws(n){var e,t;return((t=(((e=n==null?void 0:n.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||t===void 0?void 0:t.stringValue)==="server_timestamp"}function Zo(n){const e=n.mapValue.fields.__previous_value__;return Ws(e)?Zo(e):e}function _r(n){const e=wt(n.mapValue.fields.__local_write_time__.timestampValue);return new se(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Me{constructor(e){this.value=e}static empty(){return new Me({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let r=0;r<e.length-1;++r)if(t=(t.mapValue.fields||{})[e.get(r)],!ji(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=or(t)}setAll(e){let t=Ee.emptyPath(),r={},s=[];e.forEach((a,c)=>{if(!t.isImmediateParentOf(c)){const u=this.getFieldsMap(t);this.applyChanges(u,r,s),r={},s=[],t=c.popLast()}a?r[c.lastSegment()]=or(a):s.push(c.lastSegment())});const i=this.getFieldsMap(t);this.applyChanges(i,r,s)}delete(e){const t=this.field(e.popLast());ji(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return Ue(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let r=0;r<e.length;++r){let s=t.mapValue.fields[e.get(r)];ji(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(r)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,r){Pr(t,(s,i)=>e[s]=i);for(const s of r)delete e[s]}clone(){return new Me(or(this.value))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Er{constructor(e,t="asc"){this.field=e,this.dir=t}}function tv(n,e){return n.dir===e.dir&&n.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sa(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Vs(e)?"-0":e}}function md(n){return{integerValue:""+n}}function Iv(n,e){return J_(e)?md(e):sa(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Js{constructor(){this._=void 0}}function Ev(n,e,t){return n instanceof Eo?function(s,i){const a={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&Ws(i)&&(i=Zo(i)),i&&(a.fields.__previous_value__=i),{mapValue:a}}(t,e):n instanceof Os?gd(n,e):n instanceof xs?yd(n,e):function(s,i){const a=wv(s,i),c=Ul(a)+Ul(s.Pe);return yo(a)&&yo(s.Pe)?md(c):sa(s.serializer,c)}(n,e)}function Tv(n,e,t){return n instanceof Os?gd(n,e):n instanceof xs?yd(n,e):t}function wv(n,e){return n instanceof To?function(r){return yo(r)||function(i){return!!i&&"doubleValue"in i}(r)}(e)?e:{integerValue:0}:null}class Eo extends Js{}class Os extends Js{constructor(e){super(),this.elements=e}}function gd(n,e){const t=_d(e);for(const r of n.elements)t.some(s=>Ue(s,r))||t.push(r);return{arrayValue:{values:t}}}class xs extends Js{constructor(e){super(),this.elements=e}}function yd(n,e){let t=_d(e);for(const r of n.elements)t=t.filter(s=>!Ue(s,r));return{arrayValue:{values:t}}}class To extends Js{constructor(e,t){super(),this.serializer=e,this.Pe=t}}function Ul(n){return re(n.integerValue||n.doubleValue)}function _d(n){return ea(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}function Av(n,e){return n.field.isEqual(e.field)&&function(r,s){return r instanceof Os&&s instanceof Os||r instanceof xs&&s instanceof xs?gn(r.elements,s.elements,Ue):r instanceof To&&s instanceof To?Ue(r.Pe,s.Pe):r instanceof Eo&&s instanceof Eo}(n.transform,e.transform)}class Ot{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new Ot}static exists(e){return new Ot(void 0,e)}static updateTime(e){return new Ot(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function _s(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class ia{}function vd(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new Sv(n.key,Ot.none()):new oa(n.key,n.data,Ot.none());{const t=n.data,r=Me.empty();let s=new he(Ee.comparator);for(let i of e.fields)if(!s.has(i)){let a=t.field(i);a===null&&i.length>1&&(i=i.popLast(),a=t.field(i)),a===null?r.delete(i):r.set(i,a),s=s.add(i)}return new Ys(n.key,r,new mt(s.toArray()),Ot.none())}}function bv(n,e,t){n instanceof oa?function(s,i,a){const c=s.value.clone(),u=$l(s.fieldTransforms,i,a.transformResults);c.setAll(u),i.convertToFoundDocument(a.version,c).setHasCommittedMutations()}(n,e,t):n instanceof Ys?function(s,i,a){if(!_s(s.precondition,i))return void i.convertToUnknownDocument(a.version);const c=$l(s.fieldTransforms,i,a.transformResults),u=i.data;u.setAll(Id(s)),u.setAll(c),i.convertToFoundDocument(a.version,u).setHasCommittedMutations()}(n,e,t):function(s,i,a){i.convertToNoDocument(a.version).setHasCommittedMutations()}(0,e,t)}function cr(n,e,t,r){return n instanceof oa?function(i,a,c,u){if(!_s(i.precondition,a))return c;const d=i.value.clone(),f=ql(i.fieldTransforms,u,a);return d.setAll(f),a.convertToFoundDocument(a.version,d).setHasLocalMutations(),null}(n,e,t,r):n instanceof Ys?function(i,a,c,u){if(!_s(i.precondition,a))return c;const d=ql(i.fieldTransforms,u,a),f=a.data;return f.setAll(Id(i)),f.setAll(d),a.convertToFoundDocument(a.version,f).setHasLocalMutations(),c===null?null:c.unionWith(i.fieldMask.fields).unionWith(i.fieldTransforms.map(g=>g.field))}(n,e,t,r):function(i,a,c){return _s(i.precondition,a)?(a.convertToNoDocument(a.version).setHasLocalMutations(),null):c}(n,e,t)}function Bl(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!function(r,s){return r===void 0&&s===void 0||!(!r||!s)&&gn(r,s,(i,a)=>Av(i,a))}(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class oa extends ia{constructor(e,t,r,s=[]){super(),this.key=e,this.value=t,this.precondition=r,this.fieldTransforms=s,this.type=0}getFieldMask(){return null}}class Ys extends ia{constructor(e,t,r,s,i=[]){super(),this.key=e,this.data=t,this.fieldMask=r,this.precondition=s,this.fieldTransforms=i,this.type=1}getFieldMask(){return this.fieldMask}}function Id(n){const e=new Map;return n.fieldMask.fields.forEach(t=>{if(!t.isEmpty()){const r=n.data.field(t);e.set(t,r)}}),e}function $l(n,e,t){const r=new Map;ne(n.length===t.length);for(let s=0;s<t.length;s++){const i=n[s],a=i.transform,c=e.data.field(i.field);r.set(i.field,Tv(a,c,t[s]))}return r}function ql(n,e,t){const r=new Map;for(const s of n){const i=s.transform,a=t.data.field(s.field);r.set(s.field,Ev(i,a,e))}return r}class Sv extends ia{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xs{constructor(e,t,r,s,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const s=new Map;return s.set(e,kr.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new Xs($.min(),s,new ie(J),At(),K())}}class kr{constructor(e,t,r,s,i){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new kr(r,t,K(),K(),K())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gv{constructor(e){this.ct=e}}function Wv(n){const e=$v({parent:n.parent,structuredQuery:n.structuredQuery});return n.limitType==="LAST"?Ms(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let as=null;function zi(){return as===null?as=function(){return 268435456+Math.round(2147483648*Math.random())}():as++,"0x"+as.toString(16)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ye="WebChannelConnection";class II extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const r=t.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+t.host,this.vo=`projects/${s}/databases/${i}`,this.Co=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${i}`}get Fo(){return!1}Mo(t,r,s,i,a){const c=zi(),u=this.xo(t,r.toUriEncodedString());O("RestConnection",`Sending RPC '${t}' ${c}:`,u,s);const d={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(d,i,a),this.No(t,u,d,s).then(f=>(O("RestConnection",`Received RPC '${t}' ${c}: `,f),f),f=>{throw mn("RestConnection",`RPC '${t}' ${c} failed with error: `,f,"url: ",u,"request:",s),f})}Lo(t,r,s,i,a,c){return this.Mo(t,r,s,i,a)}Oo(t,r,s){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Rn}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((i,a)=>t[a]=i),s&&s.headers.forEach((i,a)=>t[a]=i)}xo(t,r){const s=_I[t];return`${this.Do}/v1/${r}:${s}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,r,s){const i=zi();return new Promise((a,c)=>{const u=new Jh;u.setWithCredentials(!0),u.listenOnce(Yh.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case ys.NO_ERROR:const f=u.getResponseJson();O(ye,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(f)),a(f);break;case ys.TIMEOUT:O(ye,`RPC '${e}' ${i} timed out`),c(new L(k.DEADLINE_EXCEEDED,"Request time out"));break;case ys.HTTP_ERROR:const g=u.getStatus();if(O(ye,`RPC '${e}' ${i} failed with status:`,g,"response text:",u.getResponseText()),g>0){let E=u.getResponseJson();Array.isArray(E)&&(E=E[0]);const b=E==null?void 0:E.error;if(b&&b.status&&b.message){const R=function(D){const M=D.toLowerCase().replace(/_/g,"-");return Object.values(k).indexOf(M)>=0?M:k.UNKNOWN}(b.status);c(new L(R,b.message))}else c(new L(k.UNKNOWN,"Server responded with status "+u.getStatus()))}else c(new L(k.UNAVAILABLE,"Connection failed."));break;default:q()}}finally{O(ye,`RPC '${e}' ${i} completed.`)}});const d=JSON.stringify(s);O(ye,`RPC '${e}' ${i} sending request:`,s),u.send(t,"POST",d,r,15)})}Bo(e,t,r){const s=zi(),i=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=ed(),c=Zh(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(u.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Oo(u.initMessageHeaders,t,r),u.encodeInitMessageHeaders=!0;const f=i.join("");O(ye,`Creating RPC '${e}' stream ${s}: ${f}`,u);const g=a.createWebChannel(f,u);let E=!1,b=!1;const R=new vI({Io:D=>{b?O(ye,`Not sending because RPC '${e}' stream ${s} is closed:`,D):(E||(O(ye,`Opening RPC '${e}' stream ${s} transport.`),g.open(),E=!0),O(ye,`RPC '${e}' stream ${s} sending:`,D),g.send(D))},To:()=>g.close()}),C=(D,M,j)=>{D.listen(M,z=>{try{j(z)}catch(V){setTimeout(()=>{throw V},0)}})};return C(g,er.EventType.OPEN,()=>{b||(O(ye,`RPC '${e}' stream ${s} transport opened.`),R.yo())}),C(g,er.EventType.CLOSE,()=>{b||(b=!0,O(ye,`RPC '${e}' stream ${s} transport closed`),R.So())}),C(g,er.EventType.ERROR,D=>{b||(b=!0,mn(ye,`RPC '${e}' stream ${s} transport errored:`,D),R.So(new L(k.UNAVAILABLE,"The operation could not be completed")))}),C(g,er.EventType.MESSAGE,D=>{var M;if(!b){const j=D.data[0];ne(!!j);const z=j,V=z.error||((M=z[0])===null||M===void 0?void 0:M.error);if(V){O(ye,`RPC '${e}' stream ${s} received error:`,V);const U=V.status;let x=function(y){const I=oe[y];if(I!==void 0)return Ed(I)}(U),v=V.message;x===void 0&&(x=k.INTERNAL,v="Unknown error status: "+U+" with message "+V.message),b=!0,R.So(new L(x,v)),g.close()}else O(ye,`RPC '${e}' stream ${s} received:`,j),R.bo(j)}}),C(c,Xh.STAT_EVENT,D=>{D.stat===mo.PROXY?O(ye,`RPC '${e}' stream ${s} detected buffering proxy`):D.stat===mo.NOPROXY&&O(ye,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{R.wo()},0),R}}function Gi(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zs(n){return new Ov(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bI{constructor(e,t,r,s,i){this.localStore=e,this.datastore=t,this.asyncQueue=r,this.remoteSyncer={},this.O_=[],this.N_=new Map,this.L_=new Set,this.B_=[],this.k_=i,this.k_._o(a=>{r.enqueueAndForget(async()=>{Nr(this)&&(O("RemoteStore","Restarting streams for network reachability change."),await async function(u){const d=W(u);d.L_.add(4),await Dr(d),d.q_.set("Unknown"),d.L_.delete(4),await ei(d)}(this))})}),this.q_=new AI(r,s)}}async function ei(n){if(Nr(n))for(const e of n.B_)await e(!0)}async function Dr(n){for(const e of n.B_)await e(!1)}function Md(n,e){const t=W(n);t.N_.has(e.targetId)||(t.N_.set(e.targetId,e),pa(t)?fa(t):kn(t).r_()&&da(t,e))}function ha(n,e){const t=W(n),r=kn(t);t.N_.delete(e),r.r_()&&Od(t,e),t.N_.size===0&&(r.r_()?r.o_():Nr(t)&&t.q_.set("Unknown"))}function da(n,e){if(n.Q_.xe(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo($.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}kn(n).A_(e)}function Od(n,e){n.Q_.xe(e),kn(n).R_(e)}function fa(n){n.Q_=new Nv({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),ot:e=>n.N_.get(e)||null,tt:()=>n.datastore.serializer.databaseId}),kn(n).start(),n.q_.v_()}function pa(n){return Nr(n)&&!kn(n).n_()&&n.N_.size>0}function Nr(n){return W(n).L_.size===0}function xd(n){n.Q_=void 0}async function SI(n){n.q_.set("Online")}async function CI(n){n.N_.forEach((e,t)=>{da(n,e)})}async function RI(n,e){xd(n),pa(n)?(n.q_.M_(e),fa(n)):n.q_.set("Unknown")}async function PI(n,e,t){if(n.q_.set("Online"),e instanceof wd&&e.state===2&&e.cause)try{await async function(s,i){const a=i.cause;for(const c of i.targetIds)s.N_.has(c)&&(await s.remoteSyncer.rejectListen(c,a),s.N_.delete(c),s.Q_.removeTarget(c))}(n,e)}catch(r){O("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),r),await Xl(n,r)}else if(e instanceof vs?n.Q_.Ke(e):e instanceof Td?n.Q_.He(e):n.Q_.We(e),!t.isEqual($.min()))try{const r=await Vd(n.localStore);t.compareTo(r)>=0&&await function(i,a){const c=i.Q_.rt(a);return c.targetChanges.forEach((u,d)=>{if(u.resumeToken.approximateByteSize()>0){const f=i.N_.get(d);f&&i.N_.set(d,f.withResumeToken(u.resumeToken,a))}}),c.targetMismatches.forEach((u,d)=>{const f=i.N_.get(u);if(!f)return;i.N_.set(u,f.withResumeToken(de.EMPTY_BYTE_STRING,f.snapshotVersion)),Od(i,u);const g=new gt(f.target,u,d,f.sequenceNumber);da(i,g)}),i.remoteSyncer.applyRemoteEvent(c)}(n,t)}catch(r){O("RemoteStore","Failed to raise snapshot:",r),await Xl(n,r)}}async function Xl(n,e,t){if(!Rr(e))throw e;n.L_.add(1),await Dr(n),n.q_.set("Offline"),t||(t=()=>Vd(n.localStore)),n.asyncQueue.enqueueRetryable(async()=>{O("RemoteStore","Retrying IndexedDB access"),await t(),n.L_.delete(1),await ei(n)})}async function Zl(n,e){const t=W(n);t.asyncQueue.verifyOperationInProgress(),O("RemoteStore","RemoteStore received new credentials");const r=Nr(t);t.L_.add(3),await Dr(t),r&&t.q_.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.L_.delete(3),await ei(t)}async function kI(n,e){const t=W(n);e?(t.L_.delete(2),await ei(t)):e||(t.L_.add(2),await Dr(t),t.q_.set("Unknown"))}function kn(n){return n.K_||(n.K_=function(t,r,s){const i=W(t);return i.w_(),new TI(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(n.datastore,n.asyncQueue,{Eo:SI.bind(null,n),Ro:CI.bind(null,n),mo:RI.bind(null,n),d_:PI.bind(null,n)}),n.B_.push(async e=>{e?(n.K_.s_(),pa(n)?fa(n):n.q_.set("Unknown")):(await n.K_.stop(),xd(n))})),n.K_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cs{constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}isEqual(e){return this.hasPendingWrites===e.hasPendingWrites&&this.fromCache===e.fromCache}}class wE extends wa{constructor(e,t,r,s,i,a){super(e,t,r,s,a),this._firestore=e,this._firestoreImpl=e,this.metadata=i}exists(){return super.exists()}data(e={}){if(this._document){if(this._converter){const t=new Is(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}get(e,t={}){if(this._document){const r=this._document.data.field(ni("DocumentSnapshot.get",e));if(r!==null)return this._userDataWriter.convertValue(r,t.serverTimestamps)}}}class Is extends wE{data(e={}){return super.data(e)}}class AE{constructor(e,t,r,s){this._firestore=e,this._userDataWriter=t,this._snapshot=s,this.metadata=new cs(s.hasPendingWrites,s.fromCache),this.query=r}get docs(){const e=[];return this.forEach(t=>e.push(t)),e}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(e,t){this._snapshot.docs.forEach(r=>{e.call(t,new Is(this._firestore,this._userDataWriter,r.key,r,new cs(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(e={}){const t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new L(k.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=function(s,i){if(s._snapshot.oldDocs.isEmpty()){let a=0;return s._snapshot.docChanges.map(c=>{const u=new Is(s._firestore,s._userDataWriter,c.doc.key,c.doc,new cs(s._snapshot.mutatedKeys.has(c.doc.key),s._snapshot.fromCache),s.query.converter);return c.doc,{type:"added",doc:u,oldIndex:-1,newIndex:a++}})}{let a=s._snapshot.oldDocs;return s._snapshot.docChanges.filter(c=>i||c.type!==3).map(c=>{const u=new Is(s._firestore,s._userDataWriter,c.doc.key,c.doc,new cs(s._snapshot.mutatedKeys.has(c.doc.key),s._snapshot.fromCache),s.query.converter);let d=-1,f=-1;return c.type!==0&&(d=a.indexOf(c.doc.key),a=a.delete(c.doc.key)),c.type!==1&&(a=a.add(c.doc),f=a.indexOf(c.doc.key)),{type:bE(c.type),doc:u,oldIndex:d,newIndex:f}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}function bE(n){switch(n){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return q()}}class SE extends TE{constructor(e){super(),this.firestore=e}convertBytes(e){return new Tn(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new nt(this.firestore,null,t)}}function fu(n){n=ko(n,tt);const e=ko(n.firestore,Wd),t=oE(e),r=new SE(e);return mE(n._query),nE(t,n._query).then(s=>new AE(e,r,n,s))}(function(e,t=!0){(function(s){Rn=s})(Sn),pn(new xt("firestore",(r,{instanceIdentifier:s,options:i})=>{const a=r.getProvider("app").getImmediate(),c=new Wd(new O_(r.getProvider("auth-internal")),new B_(r.getProvider("app-check-internal")),function(d,f){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new L(k.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new vr(d.options.projectId,f)}(a,s),a);return i=Object.assign({useFetchStreams:t},i),c._setSettings(i),c},"PUBLIC").setMultipleInstances(!0)),vt(Rl,"4.7.3",e),vt(Rl,"4.7.3","esm2017")})();const tf="fenix_cloud_sync_config",No={apiKey:"AIzaSyAvz0DRZIJLNHQsHmPg7LaUq9s3N2eEQtg",authDomain:"fenix-2c341.firebaseapp.com",projectId:"fenix-2c341",appId:"1:387287127608:web:c4e5aa07b3b91389c5b8cd",messagingSenderId:"387287127608",storageBucket:"fenix-2c341.firebasestorage.app"},Ki={enabled:!0,syncConsent:"granted",firebase:{...No}},CE=5e3;function Qi(){try{const n=localStorage.getItem(tf);if(n){const e=JSON.parse(n),t={...Ki,...e,firebase:{...Ki.firebase,...e.firebase||{}}};return nf(RE(t))}}catch(n){console.error("Failed to read cloud sync config:",n)}return{...Ki}}function RE(n){const e={...n.firebase};let t=!1;return Object.keys(No).forEach(r=>{const s=e[r];(!s||String(s).trim()==="")&&(e[r]=No[r],t=!0)}),t?{...n,firebase:e}:n}function nf(n){let e=n.syncConsent,t=n.enabled;return e||(e="pending"),e==="pending"?t=!1:e==="granted"?t=!0:e==="denied"&&(t=!1),n.syncConsent===e&&n.enabled===t?n:{...n,syncConsent:e,enabled:t}}function ls(n){try{localStorage.setItem(tf,JSON.stringify(n))}catch(e){console.error("Failed to save cloud sync config:",e)}}function PE(n){const e=n.firebase;return!!e.apiKey&&!!e.authDomain&&!!e.projectId&&!!e.appId}class kE{constructor(){this.config=null,this.app=null,this.auth=null,this.db=null,this.lastSyncAt=0,this.lastSyncCache={},this.initializing=null,this.lastSyncCursorMs=null}getSyncStatus(){this.config||(this.config=Qi());const e=nf(this.config);e!==this.config&&(this.config=e,ls(this.config));const t=this.config.enabled===!0,r=this.config.syncConsent??"pending";return{enabled:t,consent:r}}async setSyncEnabled(e){this.config||(this.config=Qi());const t=e?"granted":"denied";this.config.enabled=e,this.config.syncConsent=t,ls(this.config),e&&await this.initialize()}async initialize(){if(this.initializing)return this.initializing;this.initializing=this.initializeInternal();const e=await this.initializing;return this.initializing=null,e}async initializeInternal(){if(this.config=Qi(),typeof this.config.lastSyncCursorMs=="number"&&(this.lastSyncCursorMs=this.config.lastSyncCursorMs),!this.config.enabled)return!1;if(!PE(this.config))return console.warn("[sync] Firebase config missing. Sync disabled."),!1;if(this.app||(this.app=dh(this.config.firebase)),this.auth||(this.auth=N_(this.app)),this.db||(this.db=iE(this.app)),!this.auth.currentUser)try{await gy(this.auth)}catch(e){return console.error("Failed to sign in anonymously:",e),!1}return!0}async syncPrices(e){if(!await this.initialize()||!this.db)return{};const r=Date.now();if(!(e!=null&&e.forceFull)&&r-this.lastSyncAt<CE)return this.lastSyncCache;try{const s={},i=this.lastSyncCursorMs??0,a=!(e!=null&&e.forceFull)&&i>0;let c=a?i:0;if(a){let u=null,d=0;do{const f=[yE("updatedAt",">",se.fromMillis(i)),_E("updatedAt"),vE(500)];u&&f.push(IE(u));const g=await fu(gE(lu(this.db,"prices"),...f));if(d=g.size,d===0)break;g.forEach(E=>{const b=E.data(),R=typeof b.price=="number"?b.price:null,C=typeof b.timestamp=="number"?b.timestamp:null;if(R===null||C===null)return;const D=typeof b.listingCount=="number"?b.listingCount:void 0;s[E.id]={price:R,timestamp:C,...D!==void 0&&{listingCount:D}};const M=b.updatedAt;if(M instanceof se){const j=M.toMillis();j>c&&(c=j)}}),u=g.docs[g.docs.length-1]??null}while(d===500)}else(await fu(lu(this.db,"prices"))).forEach(d=>{const f=d.data(),g=typeof f.price=="number"?f.price:null,E=typeof f.timestamp=="number"?f.timestamp:null;if(g===null||E===null)return;const b=typeof f.listingCount=="number"?f.listingCount:void 0;s[d.id]={price:g,timestamp:E,...b!==void 0&&{listingCount:b}};const R=f.updatedAt;if(R instanceof se){const C=R.toMillis();C>c&&(c=C)}});if(c&&c!==this.lastSyncCursorMs)this.lastSyncCursorMs=c,this.config&&(this.config.lastSyncCursorMs=c,ls(this.config));else if(!this.lastSyncCursorMs||this.lastSyncCursorMs===0){const u=Date.now()-3e5;this.lastSyncCursorMs=u,this.config&&(this.config.lastSyncCursorMs=u,ls(this.config))}return this.lastSyncAt=r,this.lastSyncCache=s,s}catch(s){return console.error("Failed to sync prices from cloud:",s),{}}}}let Se=null,fn=null,De=null,pu=null,lr=null,Us=0,ur=0,Vo=!1,rr=!1,Pa=[],rf=[];async function sf(){fn=await eh(),De=new kE,await De.setSyncEnabled(!0);const n=await Qp(e=>De?De.syncPrices(e):Promise.resolve({}));Se=new Wp(fn,n),setInterval(async()=>{if(De){const e=await De.syncPrices();if(Se){const t=Se.getPriceCacheAsObject();for(const[r,s]of Object.entries(e)){const i=t[r];(!i||s.timestamp>i.timestamp)&&Se.updatePrice(r,s.price,s.listingCount,s.timestamp)}await th(Se.getPriceCacheAsObject()),of()}}},60*60*1e3),DE()}function DE(){pu||(pu=window.setInterval(()=>{Us++,Pa.forEach(n=>n({type:"realtime",seconds:Us}))},1e3))}function NE(){lr||(lr=window.setInterval(()=>{Vo&&!rr&&(ur++,Pa.forEach(n=>n({type:"hourly",seconds:ur})))},1e3))}function VE(){lr&&(clearInterval(lr),lr=null)}function of(){rf.forEach(n=>n())}const ee={async getInventory(){return Se?Se.getInventory().map(e=>e.baseId===bn?{...e,price:1}:e):[]},async getItemDatabase(){return fn||(fn=await eh()),fn},async getPriceCache(){return Se?Se.getPriceCacheAsObject():{}},onInventoryUpdate(n){rf.push(n)},startHourlyTimer(){Vo=!0,rr=!1,ur=0,NE()},pauseHourlyTimer(){rr=!0},resumeHourlyTimer(){rr=!1},stopHourlyTimer(){Vo=!1,rr=!1,ur=0,VE()},resetRealtimeTimer(){Us=0},async getTimerState(){return{realtimeSeconds:Us,hourlySeconds:ur}},onTimerTick(n){Pa.push(n)},async getAppVersion(){return"2.4.0"},async checkForUpdates(){return{success:!1,message:"Updates not available in web version"}},onUpdateStatus(n){},onUpdateProgress(n){},onShowUpdateDialog(n){},onUpdateDownloadedTransition(n){},sendUpdateDialogResponse(n){},async isLogPathConfigured(){return localStorage.getItem("fenix_log_uploaded")==="true"},async selectLogFile(){return null},onShowLogPathSetup(n){},async getSettings(){return Yp()},async saveSettings(n){try{return Xp(n),{success:!0}}catch(e){return{success:!1,error:e.message||"Failed to save settings"}}},async getUsernameInfo(){return{canChange:!1}},async setUsername(n){return{success:!1,error:"Username not supported in web version"}},async getCloudSyncStatus(){return De?De.getSyncStatus():{enabled:!1,consent:"pending"}},async setCloudSyncEnabled(n){if(!De)return{success:!1,error:"Price sync service not initialized"};try{return await De.setSyncEnabled(n),{success:!0}}catch(e){return{success:!1,error:e.message||"Failed to update cloud sync setting"}}},onShowSyncConsent(n){},async testKeybind(n){return{success:!1,error:"Keybinds not supported in web version"}},onCloseSettingsModal(n){},onWindowModeChanged(n){},minimizeWindow(){},maximizeWindow(){},closeWindow(){},onMaximizeStateChanged(n){},async getMaximizeState(){return!1},toggleOverlayWidget(){},updateOverlayWidget(n){},onWidgetPauseHourly(n){},onWidgetResumeHourly(n){}};async function af(n){return new Promise((e,t)=>{const r=new FileReader;r.onload=async s=>{var i;try{const a=(i=s.target)==null?void 0:i.result,c=em(a);if((!Se||!fn)&&await sf(),Se){if(Se.buildInventory(c),De){const u=await De.syncPrices({forceFull:!0});for(const[d,f]of Object.entries(u))Se.updatePrice(d,f.price,f.listingCount,f.timestamp)}await th(Se.getPriceCacheAsObject()),localStorage.setItem("fenix_log_uploaded","true"),of(),e()}else t(new Error("Inventory manager not initialized"))}catch(a){t(a)}},r.onerror=()=>{t(new Error("Failed to read file"))},r.readAsText(n)})}let cf=[],lf={},uf="priceTotal",hf="desc",df="",ff=null,pf=null,mf=null;function Be(){return cf}function ii(){return lf}function ka(){return uf}function Da(){return hf}function LE(){return df}function gf(){return ff}function yf(){return pf}function _f(){return mf}function ME(n){cf=n}function OE(n){lf=n}function xE(n){uf=n}function mu(n){hf=n}function gu(n){df=n}function yu(n){ff=n}function FE(n){pf=n}function UE(n){mf=n}let vf="realtime",If=[],Ef=[],Tf=new Map,wf=0,Af=!1,bf=!1,Sf=new Set,Cf=null,Rf=new Map,Pf=new Map,kf=new Map,Df=[],Nf=0,Vf=0,Lf=0,Mf=!1;function ke(){return vf}function _u(n){vf=n}function Na(){return If}function Of(n){If=n}function Dn(){return Ef}function Tr(n){Ef=n}function Vr(){return Tf}function BE(n){Tf=n}function Va(){return wf}function xf(n){wf=n}function bt(){return Af}function Ff(n){Af=n}function Uf(){return bf}function oi(n){bf=n}function Pe(){return Sf}function $E(n){Sf=n}function qE(){return Cf}function Bf(n){Cf=n}function ai(){return Rf}function jE(n){Rf=n}function La(){return Pf}function HE(n){Pf=n}function Ma(){return kf}function zE(n){kf=n}function Oa(){return Df}function ci(n){Df=n}function $f(){return Nf}function xa(n){Nf=n}function GE(){return Vf}function qf(n){Vf=n}function jf(){return Lf}function Fa(n){Lf=n}function WE(){return Mf}function KE(n){Mf=n}let Hf=!1;function QE(){return Hf}function Lo(n){Hf=n}function wn(n){const e=Math.floor(n/3600).toString().padStart(2,"0"),t=Math.floor(n%3600/60).toString().padStart(2,"0"),r=(n%60).toString().padStart(2,"0");return`${e}:${t}:${r}`}function JE(n){return n==="none"?"Uncategorized":n.split("_").map(e=>e.charAt(0).toUpperCase()+e.slice(1).toLowerCase()).join(" ")}function zf(n){if(n===null)return"";const e=Date.now()-n;return e>=Hp?"price-very-stale":e>=jp?"price-stale":""}function qt(n,e=null){return!QE()||e===bn?n:n*(1-zp)}function Ua(n){const e=yf(),t=_f();if(n.price===null)return!(e!==null&&e>0);const r=n.price*n.totalQuantity,s=qt(r,n.baseId);return!(e!==null&&s<e||t!==null&&s>t)}function li(){return Be().reduce((e,t)=>{if(!Ua(t))return e;if(t.price!==null){const r=t.totalQuantity*t.price;return e+qt(r,t.baseId)}return e},0)}function Lr(){const n=Be(),e=Vr(),t=Pe(),r=yf(),s=_f();let i=0;for(const a of n){if(a.price===null||t.has(a.baseId))continue;const c=a.totalQuantity,u=e.get(a.baseId)||0,d=c-u;if(a.baseId===bn){const f=d*a.price;i+=f}else{if(d<=0)continue;const f=d*a.price,g=qt(f,a.baseId);if(r!==null&&g<r||s!==null&&g>s)continue;i+=g}}for(const a of t){const c=n.find(E=>E.baseId===a);if(!c||c.price===null)continue;const u=c.totalQuantity,f=(e.get(a)||0)-u;if(f===0)continue;const g=Math.abs(f)*c.price;f>0?i-=g:i+=g}return i}let Gf,Wf,Ba,Kf,ui;function YE(n,e,t,r,s){Gf=n,Wf=e,Ba=t,Kf=r,ui=s}function XE(){const n=li();qf(n),ui(n)}function ZE(){console.log("🔄 Resetting realtime timer and per hour calculation"),Fa(0);const n=li();qf(n),Of([]),ee.resetRealtimeTimer(),Ba.textContent=wn(0),hr(),ui(n)}function hr(){const n=li(),e=jf()/3600,t=GE(),r=e>0?(n-t)/e:0;ui(n),ke()==="realtime"&&(Gf.textContent=n.toFixed(2),Wf.textContent=r.toFixed(2)),Kf()}async function vu(){const n=await ee.getTimerState();Fa(n.realtimeSeconds),Ba.textContent=wn(n.realtimeSeconds),console.log("✅ Realtime timer initialized")}let Qf,Jf,$a,qa,ja,Mr,Or,xr,Yf,Xf,Ha,za;function eT(n,e,t,r,s,i,a,c,u,d,f,g){Qf=n,Jf=e,$a=t,qa=r,ja=s,Mr=i,Or=a,xr=c,Yf=u,Xf=d,Ha=f,za=g}function tT(){Yf()}function Zf(){console.log("🕐 Starting hourly tracking...");const n=Be(),e=Vr(),t=ai(),r=La(),s=Ma(),i=Pe();e.clear(),t.clear(),r.clear(),s.clear();for(const a of n)e.set(a.baseId,a.totalQuantity),i.has(a.baseId)&&t.set(a.baseId,a.totalQuantity);if(Tr([]),ci([]),xa(0),ke()==="hourly"){const a=Dn();a.push({time:Date.now(),value:0}),Tr(a)}qa.style.display="none",ja.style.display="inline-block",Mr.style.display="inline-block",Or.style.display="none",$a.textContent="00:00:00",Ff(!0),oi(!1),ee.startHourlyTimer(),dr(),Ha(),za()}function nT(){const n=Be(),e=Pe(),t=ai(),r=Vr(),s=La(),i=Ma();for(const a of e){const c=n.find(f=>f.baseId===a),u=c?c.totalQuantity:0,d=t.get(a)??r.get(a)??u;if(r.get(a),u<d){const f=d-u,g=s.get(a)||0;s.set(a,g+f),console.log(`📦 Tracked usage: ${(c==null?void 0:c.itemName)||a} used ${f} (total this hour: ${g+f})`)}if(u>d){const f=u-d,g=i.get(a)||0;i.set(a,g+f),console.log(`💰 Tracked purchase: ${(c==null?void 0:c.itemName)||a} bought ${f} (total this hour: ${g+f})`)}}}function Ga(){const n=Be(),e=Pe(),t=ai();for(const r of e){const s=n.find(i=>i.baseId===r);s&&t.set(r,s.totalQuantity)}}function rT(){const n=Lr(),e=Math.floor(Va()/3600),t=$f(),r=Dn(),s=Oa(),i=Pe(),a=Be(),c=ai(),u=La(),d=Ma(),f={hourNumber:e,startValue:t,endValue:n,earnings:n-t,history:[...r]};s.push(f),ci(s),xa(n),Tr([{time:Date.now(),value:n}]),u.clear(),d.clear();for(const E of i){const b=a.find(R=>R.baseId===E);b&&c.set(E,b.totalQuantity)}const g=document.querySelector(".stats-container");if(g){const E=document.createElement("div");E.className="earnings-animation",E.textContent=`Hour ${e} Complete! +${f.earnings.toFixed(2)} FE`,E.style.color="#10b981",g.appendChild(E),setTimeout(()=>E.remove(),2e3)}}function sT(){console.log("⏸️ Pausing hourly tracking"),oi(!0),ee.pauseHourlyTimer(),Ga(),Mr.style.display="none",Or.style.display="inline-block",xr()}function iT(){console.log("▶️ Resuming hourly tracking"),oi(!1),ee.resumeHourlyTimer(),Ga(),Mr.style.display="inline-block",Or.style.display="none",xr()}function oT(){console.log("⏹️ Stopping hourly tracking"),ee.stopHourlyTimer();const n=Lr(),e=Oa(),t=Dn(),r=$f(),i={hourNumber:e.length+1,startValue:r,endValue:n,earnings:n-r,history:[...t]};e.push(i),ci(e),Xf(),qa.style.display="inline-block",ja.style.display="none",Mr.style.display="none",Or.style.display="none",$a.textContent="00:00:00",xf(0),Ff(!1),oi(!1),Ha(),za(),xr()}function dr(){const n=Lr(),e=Va()/3600,t=e>0?n/e:0;ke()==="hourly"&&(Qf.textContent=n.toFixed(2),Jf.textContent=t.toFixed(2)),xr()}function ep(){const n=Be(),e=ke(),t=bt();if(e==="hourly"&&t){const r=Vr(),s=Pe();return n.filter(i=>!s.has(i.baseId)).map(i=>{const a=i.totalQuantity,c=r.get(i.baseId)||0,u=a-c;return{...i,totalQuantity:u}}).filter(i=>i.baseId===bn?!0:i.totalQuantity>0)}return n}function aT(){const n=ep(),e=LE(),t=gf(),r=ii(),s=ka(),i=Da();let a=n.filter(c=>{if(e&&!c.itemName.toLowerCase().includes(e.toLowerCase()))return!1;if(t!==null){const u=r[c.baseId];if(((u==null?void 0:u.group)||"none")!==t)return!1}return Ua(c)});return a.sort((c,u)=>{let d=0;if(s==="priceUnit"){const f=c.price??-1,g=u.price??-1;d=f-g}else if(s==="priceTotal"){const f=qt((c.price??0)*c.totalQuantity,c.baseId),g=qt((u.price??0)*u.totalQuantity,u.baseId);d=f-g}return i==="asc"?d:-d}),a}function cT(n){if(n.pageId===null||n.slotId===null)return"";const e=n.pageId===102?"P1":n.pageId===103?"P2":`P${n.pageId}`,t=n.slotId+1;return`${e}:${t}`}function lT(){const n=document.getElementById("usageSection"),e=document.getElementById("usageContent");if(!n||!e)return;const t=ke(),r=bt(),s=Pe();if(t==="hourly"&&r&&s.size>0){n.style.display="block";const i=Be(),a=Vr(),c=ii(),u=[];for(const f of s){const g=i.find(C=>C.baseId===f),E=g?g.totalQuantity:0,R=(a.get(f)||0)-E;if(!g){const C=c[f];C&&u.push({baseId:f,itemName:C.name,netUsage:R,price:0});continue}u.push({baseId:f,itemName:g.itemName,netUsage:R,price:g.price||0})}if(u.length===0){n.style.display="none";return}u.sort((f,g)=>{const E=f.price>0?Math.abs(f.netUsage*f.price):0;return(g.price>0?Math.abs(g.netUsage*g.price):0)-E});let d=0;e.innerHTML=u.map(({baseId:f,itemName:g,netUsage:E,price:b})=>{const R=b>0?b:0,C=b>0?Math.abs(E)*b:0;E>0?d-=C:E<0&&(d+=C);const D=E>0?"-":E<0?"+":"",M=E!==0?`${D}${Math.abs(E)}`:"0",j=E>0?"-":E<0?"+":"",z=b>0&&E!==0?`${j}${C.toFixed(2)} FE`:"- FE";return`
        <div class="item-row">
          <div class="item-name">
...
<span class="price-help-icon">
  ...
  `}function OT(n){const e=document.createElement("div");return e.textContent=n,e.innerHTML}function xT(n,e,t){return[...n].sort((s,i)=>{let a,c;switch(e){case"name":a=s.name.toLowerCase(),c=i.name.toLowerCase();break;case"price":a=s.price,c=i.price;break;case"trend":a=s.trendPercent,c=i.trendPercent;break;default:return 0}return a<c?t==="asc"?-1:1:a>c?t==="asc"?1:-1:0})}function hi(){const n=document.getElementById("pricesTableBody");if(!n)return;const e=xT(op,Oo,sr),t=document.getElementById("pricesItemCount");t&&(t.textContent=`${e.length} item${e.length!==1?"s":""}`),n.innerHTML=e.map((r,s)=>MT(r)).join(""),setTimeout(()=>{e.forEach(r=>{const s=document.getElementById(`sparkline-${r.baseId}`);if(s){const i=s.getAttribute("data-prices"),a=s.getAttribute("data-trend");if(i){const c=i.split(",").map(u=>parseFloat(u));NT(s,c,a)}}})},0)}async function so(){try{const[n,e]=await Promise.all([ee.getPriceCache(),ee.getItemDatabase()]);Ku=e,Qu=n,ip=Object.entries(Ku).map(([s,i])=>{if(s===bn||i.tradable===!1)return null;const a=i.name||`Unknown Item (${s})`,c=Qu[s],u=(c==null?void 0:c.price)??0,d=(c==null?void 0:c.timestamp)??Date.now(),f=c==null?void 0:c.listingCount,g=c==null?void 0:c.history,E=u>0?DT(g,u,d):{trend:"neutral",percent:0};return{baseId:s,name:a,price:u,timestamp:d,listingCount:f,trend:E.trend,trendPercent:E.percent,group:i.group,history:g}}).filter(s=>s!==null).sort((s,i)=>s.name.localeCompare(i.name)),Ya(),hi()}catch(n){console.error("Failed to load prices:",n)}}function Ya(){let n=[...ip];if(Fo){const e=Fo.toLowerCase();n=n.filter(t=>t.name.toLowerCase().includes(e)||t.baseId.toLowerCase().includes(e))}else xo!=="all"&&(n=n.filter(e=>e.group===xo));op=n}function Ju(n){Fo=n.trim(),Ya(),hi()}function FT(n){xo=n,document.querySelectorAll(".prices-sidebar-item").forEach(e=>{e.classList.remove("active"),e.getAttribute("data-group")===n&&e.classList.add("active")}),Ya(),hi()}function UT(n){Oo===n?sr=sr==="asc"?"desc":"asc":(Oo=n,sr="asc"),document.querySelectorAll(".prices-table th").forEach(e=>{e.classList.remove("sort-asc","sort-desc"),e.getAttribute("data-sort")===n&&e.classList.add(`sort-${sr}`)}),hi()}function BT(){const n=document.getElementById("pricesSearchInput"),e=document.getElementById("pricesClearSearch"),t=document.querySelectorAll(".prices-table th[data-sort]");n&&n.addEventListener("input",i=>{const a=i.target.value;Ju(a),e&&(e.style.display=a?"block":"none")}),e&&e.addEventListener("click",()=>{n&&(n.value="",Ju(""),e.style.display="none")}),t.forEach(i=>{i.addEventListener("click",()=>{const a=i.getAttribute("data-sort");a&&UT(a)})}),document.querySelectorAll(".prices-sidebar-item").forEach(i=>{i.addEventListener("click",()=>{const a=i.getAttribute("data-group");a&&FT(a)})});const s=document.getElementById("page-prices");s&&new MutationObserver(a=>{a.forEach(c=>{c.type==="attributes"&&c.attributeName==="class"&&s.classList.contains("active")&&so()})}).observe(s,{attributes:!0}),s!=null&&s.classList.contains("active")&&so(),ee.onInventoryUpdate(()=>{const i=document.getElementById("page-prices");i!=null&&i.classList.contains("active")&&so()})}function io(){const n=ke(),e=bt();n==="hourly"&&e?Lr():li()}function ap(n){hr(),bt()&&!Uf()&&dr(),ze(be)}async function Yu(){const[n,e]=await Promise.all([ee.getInventory(),ee.getItemDatabase()]);OE(e);const t=n.map(r=>r.baseId===bn?{...r,price:1}:r);ME(t),WE()||(XE(),KE(!0)),bt()&&!Uf()&&nT(),Ga(),be(),ap(),ze(be)}async function $T(){CT(),hT(),pT(be,()=>ze(be)),AT(),bT();const n=ST();TT(be,()=>ze(be),ap,n),YE(ku,Du,pr,io,dT),eT(ku,Du,Nu,Wa,Ka,Qa,Ja,io,Iu,mT,be,()=>ze(be)),RT(be,()=>ze(be),hr,dr),PT(tT,oT,sT,iT,ZE,hr,dr,be,()=>ze(be),Bs,io,Iu,_T,vT,sp,IT,Zf,gT),kT(),BT(),ee.onTimerTick(r=>{if(r.type==="realtime")Fa(r.seconds),ke()==="realtime"&&(pr.textContent=wn(r.seconds)),hr();else if(r.type==="hourly"){xf(r.seconds),Nu.textContent=wn(r.seconds);const s=Lr();if(ke()==="hourly"){const i=Dn();i.push({time:Date.now(),value:s}),Tr(i),Bs()}dr(),be(),ze(be),r.seconds%3600===0&&r.seconds>0&&(console.log(`🎉 Hour ${Math.floor(r.seconds/3600)} completed!`),rT())}}),ee.onInventoryUpdate(()=>{Yu()});const[e,t]=await Promise.all([ee.getSettings(),ee.isLogPathConfigured()]);Lo(e.includeTax!==void 0?e.includeTax:!1),t?(await Yu(),await vu()):await vu(),tp()}async function Xu(){await sf(),await $T()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Xu):Xu();
